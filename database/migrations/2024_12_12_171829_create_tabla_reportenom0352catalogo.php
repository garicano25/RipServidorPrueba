...
class CreateTablaReportenom0352catalogo extends Migration
{
    ...
    public function up()
    {
        Schema::create('reportenom0352catalogo', function (Blueprint $table) {
            ...
            $table->text('reportenom0352catalogo_metodologia')->nullable();
            $table->text('reportenom0352catalogo_ubicacioninstalacion')->nullable();
            $table->text('reportenom0352catalogo_estrategiasmedicion')->nullable(); 
            $table->text('reportenom0352catalogo_metodoaplicacion')->nullable();

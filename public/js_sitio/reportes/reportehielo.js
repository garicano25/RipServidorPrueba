...
var agente_id = 10;
var agente_nombre = "Hielo";
var ruta_storage_guardar = '/reportehielo';
...
function datosgenerales()
{
	$.ajax({
		type: "GET",
		dataType: "json",
		url: "/reportehielodatosgenerales/"+proyecto.id+"/"+agente_id+"/"+agente_nombre,
		data:{},
		cache: false,
		success:function(dato)
		{
			...
			$('#reporte_metodologia_4_12').html(dato.reporte_metodologia_4_12);
			$('#reporte_metodologia_4_2').html(dato.reporte_metodologia_4_2);
			$('#reporte_metodologia_4_22').html(dato.reporte_metodologia_4_22);
			...
			if (dato.reporte_ubicacioninstalacion.ubicacionfoto)
			{
				...
				var imagenUrl = '/reportehielomapaubicacion/'+reporteregistro_id+'/'+0;
			...
			if (dato.reporte_responsablesinforme.responsable1)
			{
				...
				var extension = archivo.substring(archivo.lastIndexOf("."));
				var imagenUrl = '/reportehieloresponsabledocumento/'+dato.reporte_responsablesinforme.registro_id+'/'+1+'/'+0;
				...
				var extension = archivo.substring(archivo.lastIndexOf("."));
				var imagenUrl = '/reportehieloresponsabledocumento/'+dato.reporte_responsablesinforme.registro_id+'/'+2+'/'+0;
		...
		error: function(dato)
		{
			...
			$('#reporte_metodologia_4_12').html('Error al cargar los datos');
			$('#reporte_metodologia_4_2').html('Error al cargar los datos');
			$('#reporte_metodologia_4_22').html('Error al cargar los datos');
...
function tabla_reporte_definiciones(proyecto_id, agente_nombre, reporteregistro_id)
{
	try 
	{
		var ruta = "/reportehielotabladefiniciones/"+proyecto_id+"/"+agente_nombre+"/"+reporteregistro_id;
				...
				function(isConfirm)
				{
					if (isConfirm)
					{
						...
						$.ajax({
							type: "GET",
							dataType: "json",
							url: "/reportehielodefinicioneliminar/"+row.data().id,
							data:{},
							cache: false,
							success:function(dato)
							{
...
{
	window.open('/reportehielomapaubicacion/'+reporteregistro_id+'/'+1);
});
...
function tabla_reporte_categorias(proyecto_id, reporteregistro_id)
{
	try 
	{
		var ruta = "/reportehielocategorias/"+proyecto_id+"/"+reporteregistro_id+"/"+areas_poe;
		...
		else
		{
			...
			datatable_reportecategorias = $('#tabla_reporte_categoria').DataTable({
				...
				"columns": [
					...
					{
						"data": "reportehielocategoria_nombre",
						"defaultContent": "-"
					},
					{
						"data": "reportehielocategoria_total",
						"defaultContent": "-"
					},
					{
						"className": 'editar',
...
$('#tabla_reporte_categoria tbody').on('click', 'td>button.editar', function()
{
	...
	// Llenar campos
	$('#reportehielocategoria_nombre').val(row.data().reportehielocategoria_nombre);
	$('#reportehielocategoria_total').val(row.data().reportehielocategoria_total);
...
$('#tabla_reporte_categoria tbody').on('click', 'td>button.eliminar', function()
{
	...
	swal({
		title: "¡Confirme que desea eliminar!",
		text: "La categoría: "+row.data().reportehielocategoria_nombre,
		type: "warning",
		showCancelButton: true,
		confirmButtonColor: "#DD6B55",
		confirmButtonText: "Aceptar!",
			...
			function(isConfirm)
			{
				if (isConfirm)
				{
					...
					$.ajax({
						type: "GET",
						dataType: "json",
						url: "/reportehielocategoriaeliminar/"+row.data().id,
						data:{},
						cache: false,
						success:function(dato)
						{
...
$("#botonguardar_modal_categoria").click(function()
{
	...
	if (valida)
	{
		swal({
			title: "¡Confirme que desea guardar!",
			text: "Categoría: "+$("#reportehielocategoria_nombre").val(),
			type: "warning",
			showCancelButton: true,
			confirmButtonColor: "#DD6B55",
			confirmButtonText: "Guardar!",
...
function tabla_reporte_areas(proyecto_id, reporteregistro_id)
{
	try 
	{
		var ruta = "/reportehieloareas/"+proyecto_id+"/"+reporteregistro_id+"/"+areas_poe;
		...
		else
		{
			...
			datatable_reporteareas = $('#tabla_reporte_area').DataTable({
				...
				"columns": [
					...
					{
						"data": "reportehieloarea_instalacion",
						"defaultContent": "-"
					},
					{
						"data": "area_nombre",
					...
					{
						"data": "reportehieloarea_porcientooperacion",
						"defaultContent": "-"
					},
					{
						"className": 'editar',
...
$('#tabla_reporte_area tbody').on('click', 'td.editar', function()
{
	...
	// Llenar campos
	$('#reportehieloarea_instalacion').val(row.data().reportehieloarea_instalacion);
	$('#reportehieloarea_nombre').val(row.data().reportehieloarea_nombre);
	$('#reportehieloarea_numorden').val(row.data().reportehieloarea_numorden);	
	$('#reportehieloarea_porcientooperacion').val(row.data().reportehieloarea_porcientooperacion);


	if (areas_poe == 1)
	{
		$('#reportehieloarea_instalacion').attr('required', false);
		$('#reportehieloarea_instalacion').attr('disabled', true);

		$('#reportehieloarea_nombre').attr('required', false);
		$('#reportehieloarea_nombre').attr('disabled', true);

		$('#reportehieloarea_numorden').attr('required', false);
		$('#reportehieloarea_numorden').attr('disabled', true);
	}
	else
	{
		$('#reportehieloarea_instalacion').attr('disabled', false);
		$('#reportehieloarea_instalacion').attr('required', true);

		$('#reportehieloarea_nombre').attr('disabled', false);
		$('#reportehieloarea_nombre').attr('required', true);

		$('#reportehieloarea_numorden').attr('disabled', false);
		$('#reportehieloarea_numorden').attr('required', true);
	}
...
$('#tabla_reporte_area tbody').on('click', 'td>button.eliminar', function()
{
	...
	swal({
		title: "¡Confirme que desea eliminar!",
		text: "El área: "+row.data().reportehieloarea_nombre,
		type: "warning",
		showCancelButton: true,
		confirmButtonColor: "#DD6B55",
		confirmButtonText: "Aceptar!",
			...
			function(isConfirm)
			{
				if (isConfirm)
				{
					...
					$.ajax({
						type: "GET",
						dataType: "json",
						url: "/reportehieloareaeliminar/"+row.data().id,
						data:{},
						cache: false,
						success:function(dato)
						{
...
$("#botonguardar_modal_area").click(function()
{
	...
	if (valida)
	{
		swal({
			title: "¡Confirme que desea guardar!",
			text: "Área: "+$("#reportehieloarea_nombre").val(),
			type: "warning",
			showCancelButton: true,
			confirmButtonColor: "#DD6B55",
			confirmButtonText: "Guardar!",
...
function tabla_reporte_resultados(proyecto_id, reporteregistro_id)
{
	try 
	{
		var ruta = "/reportehieloevaluaciontabla/"+proyecto_id+"/"+reporteregistro_id+"/"+areas_poe;
		...
		else
		{
			...
			datatable_reporte_resultados = $('#tabla_reporte_resultados').DataTable({
				...
				columns: [
					...
					// },
					{
						data: "reportehieloevaluacion_punto",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "catparametrohielocaracteristica_tipo",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportehieloevaluacion_fecha",
						defaultContent: "-",
						orderable: false,
					},
					{
					...
					{
						data: "reportehieloarea_nombre",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportehieloevaluacion_ubicacion",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportehieloevaluacion_suministro",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "catparametrohielocaracteristica_caracteristica",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "catparametrohielocaracteristica_unidadmedida",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportehieloevaluacionparametros_metodo",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportehieloevaluacion_totalpersonas",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportehieloevaluacionparametros_obtenida",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "catparametrohielocaracteristica_concentracionpermisible",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportehieloevaluacionparametros_resultado",
						defaultContent: "-",
						orderable: false,
					},
					{
				...
				rowCallback: function(row, data, index)
				{
					...
					else if(data.reportehieloevaluacionparametros_resultado == "Fuera de norma")
					{
...
$("#boton_reporte_nuevopuntomedicion").click(function()
{
	...
	// Campo select areas
	$('#puntomedicion_reportehieloarea_id').html(selectareas);
	...
	hieloevaluacion_categorias(proyecto.id, reporteregistro_id, 0);
});


function hieloevaluacion_parametos(reportehieloevaluacion_id, reportehieloevaluacion_tipo, proveedor_id)
{
	if (reportehieloevaluacion_tipo)
	{
		// Consultar categorias
		$.ajax({
			type: "GET",
			dataType: "json",
			url: "/reportehieloevaluacionparametros/"+reportehieloevaluacion_id+"/"+reportehieloevaluacion_tipo+"/"+proveedor_id,
			data:{},
			cache: false,
			success:function(dato)
			{
...
function hieloevaluacion_categorias(proyecto_id, reporteregistro_id, reportehieloevaluacion_id)
{
	// Consultar categorias
	$.ajax({
		type: "GET",
		dataType: "json",
		url: "/reportehieloevaluacioncategorias/"+proyecto_id+"/"+reporteregistro_id+"/"+reportehieloevaluacion_id+"/"+areas_poe,
		data:{},
		cache: false,
		success:function(dato)
		{
...
function activa_hieloevaluacioncategoria(checkbox, num_registro)
{
	if (checkbox.checked)
	{
		$(".hieloevaluacioncategoria_"+num_registro).attr('readonly', false);
		$(".hieloevaluacioncategoria_"+num_registro).attr('required', true);
	}
	else
	{
		$(".hieloevaluacioncategoria_"+num_registro).val('');
		$(".hieloevaluacioncategoria_"+num_registro).attr('required', false);
		$(".hieloevaluacioncategoria_"+num_registro).attr('readonly', true);
	}
}
...
$('#tabla_reporte_resultados tbody').on('click', 'td.editar', function()
{
	...
	// Llenar campos
	$('#reportehieloevaluacion_punto').val(row.data().reportehieloevaluacion_punto);
	$('#puntomedicion_reportehieloarea_id').val(row.data().reportehieloarea_id);
	$('#reportehieloevaluacion_ubicacion').val(row.data().reportehieloevaluacion_ubicacion);
	$('#reportehieloevaluacion_suministro').val(row.data().reportehieloevaluacion_suministro);
	$('#reportehieloevaluacion_tipouso').val(row.data().reportehieloevaluacion_tipouso);
	$('#reportehieloevaluacion_descripcionuso').val(row.data().reportehieloevaluacion_descripcionuso);
	$('#reportehieloevaluacion_condiciones').val(row.data().reportehieloevaluacion_condiciones);
	$('#reportehieloevaluacion_fecha').val(row.data().reportehieloevaluacion_fecha);
	$('#reportehieloevaluacion_totalpersonas').val(row.data().reportehieloevaluacion_totalpersonas);
	$('#reportehieloevaluacion_geo').val(row.data().reportehieloevaluacion_geo);
	$('#reportehieloevaluacion_foliomuestra').val(row.data().reportehieloevaluacion_foliomuestra);
	$('#reportehieloevaluacion_tipoevaluacion').val(row.data().reportehieloevaluacion_tipoevaluacion);


	// Titulo del modal
	$('#modal_reporte_puntomedicion .modal-title').html('Punto de medición '+row.data().reportehieloevaluacion_punto);
	...
	// Vaciar tabla parametros	
	hieloevaluacion_parametos(row.data().id, row.data().reportehieloevaluacion_tipoevaluacion, proveedor_id);


	// Consultar categorias
	hieloevaluacion_categorias(proyecto.id, reporteregistro_id, row.data().id);
});
...
$('#tabla_reporte_resultados tbody').on('click', 'td>button.eliminar', function()
{
	...
	swal({
		title: "¡Confirme que desea eliminar!",
		text: "Punto "+row.data().reportehieloevaluacion_punto+" de medición de hielo",
		type: "warning",
		showCancelButton: true,
		confirmButtonColor: "#DD6B55",
		confirmButtonText: "Aceptar!",
			...
			function(isConfirm)
			{
				if (isConfirm)
				{
					...
					$.ajax({
						type: "GET",
						dataType: "json",
						url: "/reportehieloevaluacioneliminar/"+row.data().id,
						data:{},
						cache: false,
						success:function(dato)
						{
...
$("#botonguardar_modal_puntomedicion").click(function()
{
	...
	if (valida)
	{
		swal({
			title: "¡Confirme que desea guardar!",
			text: "Punto de medición de hielo",
			type: "warning",
			showCancelButton: true,
			confirmButtonColor: "#DD6B55",
			confirmButtonText: "Guardar!",
...
function tabla_reporte_matriz(proyecto_id, reporteregistro_id)
{
	try 
	{
		var ruta = "/reportehielomatriztabla/"+proyecto_id+"/"+reporteregistro_id+"/"+areas_poe;
			...
			else
			{
				$('#tabla_reporte_matriz').html('<thead>'+
													...
													'<tr>'+
														...
														'<th>Mesofílicos<br>aerobios<br>100 UFC/100 mL</th>'+
														'<th>Coliformes<br>fecales<br>(ND) NMP/100 mL</th>'+
														'<th>Coliformes<br>totales<br>< 1,1 NMP/100 mL</th>'+
													'</tr>'+
												'</thead>'+
												'<tbody></tbody>');
				...
				datatable_reporte_matriz = $('#tabla_reporte_matriz').DataTable({
					...
					columns: [
						...
						{
							data: "reportehieloevaluacioncategorias_nombre",
							defaultContent: "-",
							orderable: false,
						},
						{
							data: "reportehieloevaluacioncategorias_ficha",
							defaultContent: "-",
							orderable: true,
						},
						{
						...
						{
							data: "reportehieloevaluacion_geo",
							defaultContent: "-",
							orderable: false,
						},
						{
		...
		else  // REGION MARINA
		{
			...
			else
			{
				...
				datatable_reporte_matriz = $('#tabla_reporte_matriz').DataTable({
					...
					lengthMenu: [[20, 50, 100, -1], [20, 50, 100, "Todos"]],
					rowsGroup: [1, 2, 3, 0, 7, 8, 9, 10, 11, 12], //agrupar filas
					order: [[ 0, "ASC" ]],
					ordering: false,
					processing: true,
					searching: true,
...
function reporte_dashboard(proyecto_id, reporteregistro_id, reporte_tipo)
{
	...
	$.ajax({
		type: "GET",
		dataType: "json",
		url: "/reportehielodashboard/"+proyecto_id+"/"+reporteregistro_id+"/"+reporte_tipo+"/"+areas_poe,
		data:{},
		cache: false,
		success:function(dato)
		{
...
function tabla_reporte_recomendaciones(proyecto_id, reporteregistro_id, agente_nombre)
{
	try 
	{
		var ruta = "/reportehielorecomendacionestabla/"+proyecto_id+"/"+reporteregistro_id+"/"+agente_nombre;
...
function tabla_reporte_10(proyecto_id, reporteregistro_id)
{
	try 
	{
		var ruta = "/reportehielomaterialutilizado/"+proyecto_id+"/"+reporteregistro_id;
		...
		else
		{
		    ...
		    datatable_reporte_10 = $('#tabla_reporte_10').DataTable({
				...
				columns: [
					...
					{
						data: "reportehielomaterial_nombre",
						defaultContent: "-",
						orderable: false,
					},
					{
...
$('#tabla_reporte_10 tbody').on('click', 'td.editar', function()
{
	...
	// Llenar campos
	$('#reportehielomaterial_nombre').val(row.data().reportehielomaterial_nombre);
...
$('#tabla_reporte_10 tbody').on('click', 'td>button.eliminar', function()
{
	...
	swal({
		title: "¡Confirme que desea eliminar!",
		text: "Material utilizado ("+row.data().reportehielomaterial_nombre+")",
		type: "warning",
		showCancelButton: true,
		confirmButtonColor: "#DD6B55",
		confirmButtonText: "Aceptar!",
			...
			function(isConfirm)
			{
				if (isConfirm)
				{
					...
					$.ajax({
						type: "GET",
						dataType: "json",
						url: "/reportehielomaterialutilizadoeliminar/"+row.data().id,
						data:{},
						cache: false,
						success:function(dato)
						{
...
{
	window.open('/reportehieloresponsabledocumento/'+reporteregistro_id+'/'+1+'/'+1);
});


$("#boton_descargarresponsabledoc2").click(function()
{
	window.open('/reportehieloresponsabledocumento/'+reporteregistro_id+'/'+2+'/'+1);
});
...
function tabla_reporte_planos(proyecto_id, reporteregistro_id, agente_nombre)
{
	try 
	{
		var ruta = "/reportehieloplanostabla/"+proyecto_id+"/"+reporteregistro_id+"/"+agente_nombre;
...
function tabla_reporte_anexosresultados(proyecto_id, reporteregistro_id, agente_nombre)
{
	try 
	{
		var ruta = "/reportehieloanexosresultadostabla/"+proyecto_id+"/"+reporteregistro_id+"/"+agente_nombre;
...
function tabla_reporte_acreditacionaprobacion(proyecto_id, reporteregistro_id, agente_nombre)
{
	try 
	{
		var ruta = "/reportehieloanexosacreditacionestabla/"+proyecto_id+"/"+reporteregistro_id+"/"+agente_nombre;
...
function tabla_reporte_revisiones(proyecto_id)
{
	try 
	{
		var ruta = "/reportehielorevisionestabla/"+proyecto_id;
			...
			function(isConfirm)
			{
				if (isConfirm)
				{
					...
					$.ajax({
						type: "GET",
						dataType: "json",
						url: "/reportehielorevisionconcluir/"+reporte_id,
						data:{},
						cache: false,
						success:function(dato)
						{
...
$("#boton_reporte_nuevarevision").click(function()
{
	if (ultimaversion_cancelada == 1)
	{
			...
			swal({
				...
				if (isConfirm)
				{
					...
					$.ajax({
						type: "GET",
						dataType: "json",
						url: "/reportehielorevisionparametros/"+proyecto.id+"/"+reporteregistro_id+"/"+ultimarevision_id+"/"+ultimarevision_id,
						data:{},
						cache: false,
						success:function(dato)
						{
		...
		else
		{
			...
			swal({
				title: "No disponible",
				text: "Aun no se ha evaluado ningún punto para este informe de hielo",
				type: "info", // warning, error, success, info
				buttons: {
					visible: false, // true , false
				},
...
function revision_crear()
{
	...
	$.ajax({
		...
		{
			reporte_dashboard(proyecto.id, reporteregistro_id, "Fisicoquímico_Microbiológico");
			console.log("Error al consultar los parametros evaluados en este informe");
...
$('#tabla_reporte_revisiones tbody').on('click', 'td>button.botondescarga', function()
{
	...
	$.ajax({
		type: "GET",
		dataType: "json",
		url: "/reportehielorevisionparametros/"+proyecto.id+"/"+reporteregistro_id+"/"+row.data().id+"/"+ultimarevision_id,
		data:{},
		cache: false,
		success:function(dato)
		{
...
$("#botonguardar_modal_imprimirtipo").click(function()
{
	...
	if (valida)
	{
		// alert(proyecto.id+' - '+$("#imprimirtipo_registro_id").val()+' - '+$("#imprimirtipo_tipoinforme").val());
		...
		if (parseInt($("#imprimirtipo_ultima_revision").val()) > 0)
		{
			...
			$.ajax({
				type: "GET",
				dataType: "json",
				url: "/reportehielodashboard/"+proyecto.id+"/"+$("#imprimirtipo_registro_id").val()+"/"+$("#imprimirtipo_tipoinforme").val()+"/"+areas_poe,
				data:{},
				cache: false,
				success:function(dato)
				{
					...
					html2canvas(document.querySelector("#tabla_dashboard"), { scale: 6}).then(canvas =>
					{
						...
						setTimeout(function()
						{
							...
							$.ajax({
								...
								success:function(dato)
								{
									ventana = window.open('/reportehieloworddescargar/'+proyecto.id+"/"+$("#imprimirtipo_revision_id").val()+"/"+$("#imprimirtipo_tipoinforme").val()+"/"+$('#imprimirtipo_ultima_revision').val());
			...
			// ventana = window.open("/reportehieloword/"+proyecto.id+"/"+$("#imprimirtipo_registro_id").val()+"/"+$("#imprimirtipo_tipoinforme").val());
...
$('#btn_descargar_plantilla').on('click', function (e) {
    ...
    function(isConfirm) {
        if (isConfirm) {
			...
			url = 'descargarPortadaInformes/' + proyecto.id + '/' + 10;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    a.href = url;
                    a.download = `Plantilla principal (Hielo) - ${instalacion}.docx`;

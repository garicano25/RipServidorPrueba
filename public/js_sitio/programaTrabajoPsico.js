...
function tablaprogramaTrabajoPsico() {
	try {
		var ruta = "/tablaProgramaPsico";
...
function tabla_signatarios(proyecto_id) {
	try {
		var ruta = "/proyectosignatariosinventarioPsico/" + proyecto_id;
		...
		if (datatable_signatarios != null) {
			...
			// Inicializa el DataTable si aún no está definido
			datatable_signatarios = $('#tabla_proyectosignatarios').DataTable({
				"ajax": {
					...
					"cache": false,
					error: function (xhr, error, code) {
						console.error("Error en la carga de datos:", code);
					}
				},
				"columns": [
					{ "data": "numero_registro", "defaultContent": "-" },
					{ "data": "proveedor_NombreComercial", "defaultContent": "-" },
					{ "data": "disponibilidad", "defaultContent": "-" },
					{ "data": "checkbox", "defaultContent": "-", "orderable": false },
					{ "data": "signatario_Nombre", "defaultContent": "-" },
					{ "data": "signatario_alcances", "defaultContent": "-", "orderable": false },
					{ "data": "signatario_acreditaciones", "defaultContent": "-" }
				],
				"lengthMenu": [[20, 50, 100, -1], [20, 50, 100, "Todos"]],
				"ordering": false,
				"processing": true,
		...
		console.error("Error en la función tabla_signatarios:", exception);
	}
}
...
function tabla_equipos(proyecto_id) {
	try {
		var ruta = "/proyectoequiposinventarioPsico/" + proyecto_id;
...
function tabla_vehiculos(proyecto_id) {
	try {
		var ruta = "/proyectovehiculosinventarioPsico/" + proyecto_id;

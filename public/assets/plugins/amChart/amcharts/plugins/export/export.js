...
if ( !AmCharts.translations[ "export" ][ "en" ] ) {
	AmCharts.translations[ "export" ][ "en" ] = {
		"fallback.save.text": "CTRL + C para copiar en portapapeles",
		...
		"label.saved.from": " " //"label.saved.from": "Guardado de: "
	}
}

//Modificacion al español
/*if ( !AmCharts.translations[ "export" ][ "en" ] ) {
	AmCharts.translations[ "export" ][ "en" ] = {
			...
			loadResource: function( src, addons ) {
				...
				if ( !exist || _this.libs.reload ) {
					...
					node.addEventListener( "error", function() {
						_this.handleLog( [ "amCharts[export]: Cargando error en ", this.src || this.href ].join( "" ) );
					} );

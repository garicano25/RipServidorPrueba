	...
	<div class="col-xlg-2 col-lg-3 col-md-5">
		<div class="stickyside">
			<div class="list-group" id="top-menu">
				...
				<a href="#4_3_1" class="list-group-item subsubmenu">4.3.1.- Límites máximos permisibles del hielo para uso y/o consumo humano <i class="fa fa-times" id="menureporte_4_3_1"></i></a>
				...
				<a href="#5_5" class="list-group-item submenu">5.5.- Descripción del manejo del hielo en la instalación <i class="fa fa-times" id="menureporte_5_5"></i></a>
				...
				<a href="#7_3" class="list-group-item submenu">7.3.- Análisis del manejo, recipientes y dispensadores de hielo en la instalación <i class="fa fa-times" id="menureporte_7_3"></i></a>
	...
	<div class="col-xlg-10 col-lg-9 col-md-7">
		<div class="card">
			<div class="card-body">
					...
					<form method="post" enctype="multipart/form-data" name="form_reporte_metodologia_4_1" id="form_reporte_metodologia_4_1">
						<div class="row">
							...
							<div class="col-12">
								<div class="form-group">
									<label style="color: #000000;">Microbiológico</label>
									<textarea  class="form-control" style="margin-bottom: 0px;" rows="8" id="reporte_metodologia_4_12" name="reporte_metodologia_4_12" required></textarea>
								</div>
							</div>
							<div class="col-12" style="text-align: right;">
					...
					<form method="post" enctype="multipart/form-data" name="form_reporte_metodologia_4_2" id="form_reporte_metodologia_4_2">
						<div class="row">
							...
							<div class="col-12">
								<div class="form-group">
									<label style="color: #000000;">Microbiológico</label>
									<textarea  class="form-control" style="margin-bottom: 0px;" rows="12" id="reporte_metodologia_4_22" name="reporte_metodologia_4_22" required></textarea>
								</div>
							</div>
							<div class="col-12" style="text-align: right;">
				...
				<h4 class="card-title" id="4_3_1">4.3.1.- Límites máximos permisibles del hielo para uso y/o consumo humano</h4>
					<div class="row">
						<style type="text/css">
							.texto_metodologia
							{
						...
						<div class="col-6">
							...
							<div class="informacion_estatica"><br>
								...
								<table class="table tabla_metodologia" width="100%">
									<thead>
										<tr>
											<th width="50%" colspan="2">Tabla 5.1.5.1.3<br>Límites permisibles de metales, metaloides y compuestos inorgánicos</th>
										</tr>
										<tr>
											<th width="50%">Característica</th>
											<th width="50%">Límite permisible mg/L</th>
									...
									<tbody>
										...
										<tr>
											<td>Nitrógeno de nitratos</td>
											<td>10.00</td>
										</tr>
										<tr>
											<td>Nitrógeno de nitritos</td>
											<td>0.06</td>
										</tr>
										<tr>
											<td>Plomo</td>
									...
									<tfoot>
										<tr>
											<td colspan="2" style="text-align: left!important;">
												<b>(5):</b> No aplica para aguas minerales naturales.<br>
												<b>(6):</b> Aplica para aguas minerales naturales
											</td>
										</tr>
										<tr>
											<td colspan="2">Tabla obtenida de la NOM-201-SSA1-2015</td>
										</tr>
									</tfoot>
								</table>
							</div>
						...
						<div class="col-6">
							...
							<div class="informacion_estatica"><br>
								<table class="table tabla_metodologia" width="100%">
									<thead>
										<tr>
											<th width="50%" colspan="2">Límites permisibles de calidad del hielo</th>
										</tr>
										<tr>
											<th width="50%">Característica</th>
								...
								<table class="table tabla_metodologia" width="100%">
									...
									<tbody>
										<tr>
											<td rowspan="3" style="vertical-align: middle!important;">Organismos coliformes totales</td>
											<td>< 1,1 NMP/100 mL</td>
										</tr>
										<tr>
											<td>CERO UFC/100 mL</td>
										</tr>
										<tr>
											<td>Ausencia Organismos / 100 mL</td>
										</tr>
										<tr>
				...
				<h4 class="card-title" id="5_3">5.3.- Descripción del proceso de elaboración del producto terminado en la instalación</h4>
					<form method="post" enctype="multipart/form-data" name="form_reporte_procesoelaboracion" id="form_reporte_procesoelaboracion">
						<div class="row">
							...
							<div class="col-12">
								<div class="form-group">
									<textarea  class="form-control" style="margin-bottom: 0px;" rows="5" id="reporte_procesoelaboracion" name="reporte_procesoelaboracion" required></textarea>
								</div>
							</div>
							<div class="col-12" style="text-align: right;">
				...
				<h4 class="card-title" id="5_5">5.5.- Descripción del manejo del hielo en la instalación</h4>
					<div class="row">
						<div class="col-12">
							<p class="justificado">Durante el recorrido dentro de la instalación <b class="div_instalacion_nombre" style="color: #000000;">NOMBRE INSTALACION</b> se hizo un reconocimiento con el fin de saber la descripción del manejo del hielo. El cual se presenta en la siguiente tabla:</p><br>
				...
				<h4 class="card-title" id="6_2">6.2.- Método de evaluación</h4>
					<div class="row">
						<div class="col-12">
							<p class="justificado">En la siguiente tabla se indican las áreas con sus respectivos parámetros, métodos y sus límites permisibles:</p><br>
							...
							<p class="justificado">Nota: La toma de muestras se realizó por un signatario acreditado en muestreo de hielo el cual aparece dentro de esta acreditación bajo este carácter. Además, para el presente apartado cabe mencionar que los métodos de carácter analítico, son realizados por el laboratorio autorizado para el análisis que aparece referenciado en el informe de resultados y se encuentra para consulta en el registro del laboratorio ante la entidad mexicana de acreditación (ema).</p>
						</div>
					</div>
				...
				<h4 class="card-title" id="7_1">7.1.- Tabla de resultados</h4>
					<div class="row">
						<div class="col-12">
							<p class="justificado">A continuación, se presentan de manera detallada los resultados obtenidos en la evaluación de la calidad del hielo respecto a los parámetros fisicoquímicos y/o microbiológicos por punto de muestreo:</p>
							<ol class="breadcrumb" style="padding: 6px; margin: 10px 0px;">
				...
				<h4 class="card-title" id="7_2">7.2.- Análisis de los resultados</h4>
					<div class="row">
						<div class="col-12">
							<p class="justificado">Durante la evaluación se obtuvieron los siguientes resultados:</p><br>
							<style type="text/css">
				...
				<h4 class="card-title" id="7_3">7.3.- Análisis del manejo, recipientes y dispensadores de hielo en la instalación</h4>
					<div class="row">
						<div class="col-12">
							<p class="justificado">En la siguiente tabla se presenta las áreas, punto de localización, equipo de suministro (recipientes y/o dispensadores) así como una descripción de las condiciones del medio por punto de muestreo y el número de puntos evaluados:</p><br>
							<div class="informacion_estatica">
				...
				<h4 class="card-title" id="7_4">7.4.- Matriz de exposición laboral</h4>
					<div class="row">
						<div class="col-12">
							<p class="justificado">A continuación, se muestra un concentrado de los valores obtenidos en los diversos parámetros evaluados para determinar la calidad del hielo:</p>
							<style type="text/css">
							...
							<p class="justificado"><b>N/A:</b> No Aplica<br><b>ND:</b> No Detectable</p>
						</div>
					</div>
							...
							<form method="post" enctype="multipart/form-data" name="form_reporte_conclusion" id="form_reporte_conclusion">
								<div class="row">
									...
									<div class="col-12">
										...
										<div class="form-group">
											<label style="color: #000000;">Microbiológico</label>
											<textarea  class="form-control" style="margin-bottom: 0px;" rows="13" id="reporte_conclusion2" name="reporte_conclusion2" required></textarea>
										</div>
									</div>
									<div class="col-12" style="text-align: right;">
										<div class="form-group">
										...
										<tr>
											<th colspan="4">
												<b style="font-size:1.1vw!important; font-weight: 600; color: #000000;">
													Evaluación de Calidad de Hielo (<span id="dashboard_titulo">tipo</span>) para Uso y Consumo Humano en:<br><span class="div_instalacion_nombre">NOMBRE INSTALACION</span>.
												</b>
											</th>
										</tr>
										<tr>
											<th width="30%" colspan="2">Áreas evaluadas</th>
											<th width="70%" colspan="2">Cumplimiento normativo en calidad del hielo</th>
										</tr>
										<tr>
						...
						<div class="col-12">
							...
							<table class="table table-hover tabla_info_centrado" width="100%" id="tabla_reporte_10">
								<thead>
									<tr>
										<th width="60">No.</th>
										<th>Equipo y material utilizado para evaluar hielo</th>
										<th width="60">Editar</th>
										<th width="60">Eliminar</th>
									</tr>
								</thead>
				...
				<h4 class="card-title" id="12_1">12.1.- Anexo 1: Memoria fotográfica</h4>
					<div class="row">
						<div class="col-12" style="padding-top: 10px;">
							<p class="justificado"><b style="color: #333333; font-weight: bold;">Nota del software:</b> Las fotos encontradas se agregaran en la impresión del informe de hielo.<br><br><span id="reporte_memoriafotografica_lista">● Lista</span></p>
						</div>
					</div>
				<h4 class="card-title" id="12_2">12.2.-	Anexo 2: Planos de ubicación de los puntos de muestreo</h4>
					<form method="post" enctype="multipart/form-data" name="form_reporte_planos" id="form_reporte_planos">
						<div class="row">
							...
							<div class="col-12">
								<p class="justificado"><b style="color: #333333; font-weight: bold;">Nota del software:</b> Los planos de las carpetas seleccionadas se agregaran en el informe de hielo.</p><br>
				...
				<h4 class="card-title" id="12_4">12.4.-	Anexo 4: Copia de aprobación del laboratorio de ensayo ante la STPS</h4>
					<div class="row">
						<div class="col-12" style="padding-top: 10px;">
					...
					<div class="row">
						<div class="col-12" style="padding-top: 10px;">
							...
							<p class="justificado">Para lo solicitado en el presente apartado cabe mencionar que la aprobación del laboratorio de ensayo por parte de la STPS no aplica para las evaluaciones de calidad del hielo, debido a que la normatividad pertenece a otro sector y/o dependencia gubernamental (Secretaría de Salud).</p>
						</div>
					</div>
				<h4 class="card-title" id="12_5">12.5.-	Anexo 5: Copia del registro del laboratorio ante la entidad mexicana de acreditación (ema)</h4>
					<div class="row">
						<div class="col-12" style="padding-top: 10px;">
					...
					<div class="row">
						...
						<div class="col-8">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="reportehielocategoria_nombre" name="reportehielocategoria_nombre" required>
							</div>
						</div>
						<div class="col-4">
							<div class="form-group">
								<label>Total personal</label>
								<input type="number" class="form-control" id="reportehielocategoria_total" name="reportehielocategoria_total" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-9">
							<div class="form-group">
								<label>Instalación</label>
								<input type="text" class="form-control" id="reportehieloarea_instalacion" name="reportehieloarea_instalacion" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Área No. orden</label>
								<input type="number" class="form-control" id="reportehieloarea_numorden" name="reportehieloarea_numorden" required>
							</div>
						</div>
						<div class="col-9">
							<div class="form-group">
								<label>Nombre del área</label>
								<input type="text" class="form-control" id="reportehieloarea_nombre" name="reportehieloarea_nombre" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>% de operacion</label>
								<input type="number" step="any" min="0" max="100" class="form-control" id="reportehieloarea_porcientooperacion" name="reportehieloarea_porcientooperacion" required>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-2">
							<div class="form-group">
								...
								<input type="number" min="1" class="form-control" id="reportehieloevaluacion_punto" name="reportehieloevaluacion_punto" required>
							</div>
						</div>
						<div class="col-4">
							<div class="form-group">
								<label>Área</label>
								<select class="custom-select form-control" id="puntomedicion_reportehieloarea_id" name="reportehieloarea_id" required>
									<option value=""></option>
								</select>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="reportehieloevaluacion_ubicacion" name="reportehieloevaluacion_ubicacion" placeholder="Ej.: Hielera" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Suministro</label>
								<input type="text" class="form-control" id="reportehieloevaluacion_suministro" name="reportehieloevaluacion_suministro" placeholder="Ej.: Hielera" required>
							</div>
						</div>
						<div class="col-2">
							<div class="form-group">
								<label>Tipo uso</label>
								<select class="custom-select form-control" id="reportehieloevaluacion_tipouso" name="reportehieloevaluacion_tipouso" required>
									<option value=""></option>
						...
						<div class="col-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="reportehieloevaluacion_descripcionuso" name="reportehieloevaluacion_descripcionuso" placeholder="Ej.: Usado para la hidratación del personal" required>
							</div>
						</div>
						<div class="col-6">
							<div class="form-group">
								<label>Condiciones del medio</label>
								<input type="text" class="form-control" id="reportehieloevaluacion_condiciones" name="reportehieloevaluacion_condiciones" placeholder="Ej.: Se observa en mal estado, con limpieza superficial aparente" required>
							</div>
						</div>
						<div class="col-2">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control mydatepicker" id="reportehieloevaluacion_fecha" name="reportehieloevaluacion_fecha" placeholder="aaaa-mm-dd" required>
						...
						<div class="col-2">
							<div class="form-group">
								...
								<input type="number" min="0" class="form-control" id="reportehieloevaluacion_totalpersonas" name="reportehieloevaluacion_totalpersonas" required>
							</div>
						</div>
						<div class="col-2">
							<div class="form-group">
								<label>Grupo exp. homo.</label>
								<input type="number" min="0" class="form-control" id="reportehieloevaluacion_geo" name="reportehieloevaluacion_geo" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Folio de la muestra de hielo</label>
								<input type="text" class="form-control" id="reportehieloevaluacion_foliomuestra" name="reportehieloevaluacion_foliomuestra" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Tipo evaluación</label>
								<select class="custom-select form-control" id="reportehieloevaluacion_tipoevaluacion" name="reportehieloevaluacion_tipoevaluacion" required onchange="hieloevaluacion_parametos(form_modal_puntomedicion.puntomedicion_id.value, this.value, proveedor_id);">
									<option value=""></option>
										...
										{{-- <tr>
											<td>
												<div class="switch" style="float: left;">
													<label>
														<input type="checkbox" class="checkbox_alcance" name="hieloevaluacioncategoria_id[]" value="0">
											...
											<td>
												<input type="text" class="form-control" placeholder="nombre" name="reportehieloevaluacioncategoria_nombre[]" required>
											</td>
											<td>
												<input type="text" class="form-control" placeholder="ficha" name="reportehieloevaluacioncategoria_ficha[]" required>
											</td>
										</tr> --}}
									</tbody>
								</table>
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="reportehielomaterial_nombre" name="reportehielomaterial_nombre" required>
							</div>
						</div>
					</div>
				</div>
...
<script src="/js_sitio/reportes/reportehielo.js"></script>
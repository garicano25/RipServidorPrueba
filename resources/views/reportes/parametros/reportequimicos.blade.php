						...
						<div class="row">
							...
							<div class="col-4">
								<div class="form-group">
									...
									{{-- <span id="reporteregistro_id">0</span> --}}
								</div>
							</div>
							<div class="col-4"></div>
						...
						<div class="row">
							...
							<div class="col-12">
								<div class="informacion_estatica">
									...
									Cuando la jornada laboral del personal ocupacionalmente expuesto sea diferente de 8 horas diarias, en el intervalo de 6 a 12 horas se deberá calcular el factor de corrección FC día, con la ecuación siguiente:</p>
									...
									El valor límite de exposición corregido (VLE <sub>corregido</sub>), contra el cual será comparado la concentración medida en el ambiente laboral (CMA), se calculará con la ecuación siguiente:</p>

					...
					<form method="post" enctype="multipart/form-data" name="form_reporte_portada" id="form_reporte_portada">
						<div class="row">
							...
							<div class="col-4">
								<div class="form-group">
									<label>Fecha</label>
									<input type="text" class="form-control" id="reporteiluminacion_fecha" name="reporteiluminacion_fecha" required>
									{{-- <h2 id="reporteiluminacion_id">0</h2> --}}
								</div>
							</div>
							<div class="col-4"></div>
					...
					<div class="row">
						<div class="col-12">
							...
							<table class="table-hover tabla_info_centrado" width="100%" id="tabla_reporte_6_2_1">
								<thead>
									<tr>
										<th colspan="8"><h3>Total de puntos evaluados por índice de área (<span id="total_ic">0</span>)</h3></th>
									</tr>
									<tr>
					...
					<div class="row">
						<div class="col-12">
							...
							<table class="table-hover tabla_info_centrado" width="100%" id="tabla_reporte_6_2_2">
								<thead>
									<tr>
										<th colspan="6"><h3>Total de puntos evaluados por puesto de trabajo (<span id="total_pt">0</span>)</h3></th>
									</tr>
									<tr>
										<th width="80">Puntos<br>evaluados</th>
										<th width="130">Instalación</th>
			...
			<form method="post" enctype="multipart/form-data" name="form_reporte_area" id="form_reporte_area">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-6">
							<div class="form-group">
								<label>Sistema de iluminación</label>
								<input type="text" class="form-control" id="reportearea_sistemailuminacion" name="reportearea_sistemailuminacion" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
						...
						<div class="col-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="reportearea_colorsuperficie" name="reportearea_colorsuperficie" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Tipo de superficie</label>
								<input type="text" class="form-control" id="reportearea_tiposuperficie" name="reportearea_tiposuperficie" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Largo del área</label>
								<input type="number" step="any" class="form-control" id="reportearea_largo" name="reportearea_largo" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Ancho del área</label>
								<input type="number" step="any" class="form-control" id="reportearea_ancho" name="reportearea_ancho" required>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
								<label>Alto del área</label>
					...
					<div class="row">
						<div class="col-12">
							<ol class="breadcrumb" style="padding: 6px; margin: 0px 0px 10px 0px; text-align: center;">

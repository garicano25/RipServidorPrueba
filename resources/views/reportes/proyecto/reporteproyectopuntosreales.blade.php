...
<body>
            ...
            <tbody>
                <tr>
                    ...
                    <td rowspan="2" width="60%">
                        <h1>Reporte de puntos reales</h1>
                    </td>
                    <td width="20%">
                        <b>Fecha impresión:</b><br>{{ date('Y-m-d') }}
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" id="tabla_listaservicios">
        <thead>
            <tr>
                <th colspan="6">PUNTOS REALES</th>
            </tr>
            <tr>
                <th width="30">No.</th>
                <th width="80">Proveedor</th>
                <th width="100">Agente /<br>Factor de riesgo /<br>Servicio</th>
                <th width="40">Puntos<br>prog.</th>
                <th width="40">Puntos<br>reales</th>
                <th>Observación</th>
            </tr>
        </thead>
        <tbody>
            @php $fila = 0; @endphp
            @foreach($puntosrealeslista as $lista)
                @php $fila += 1; @endphp
                <tr>
                    <td>{{ $fila }}</td>
                    <td>{{ $lista->proveedor_NombreComercial }}</td>
                    <td>{{ $lista->proyectoproveedores_agente }}</td>
                    <td>{{ $lista->proyectoproveedores_puntos }}</td>
                    <td><b>{{ $lista->proyectopuntosreales_puntos }}</b></td>
                    <td style="text-align: justify;">{{ $lista->proyectopuntosreales_observacion }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>

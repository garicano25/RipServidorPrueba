...
<body>
            ...
            <tbody>
                <tr>
                    ...
                    <td rowspan="2" width="60%">
                        ...
                        @if($vehiculoslista['proyectovehiculo_revision'] > 0)
                        (Rev-{{ $vehiculoslista['proyectovehiculo_revision'] }})
                        @endif

                        @if($vehiculoslista['proyectovehiculo_cancelado'] > 0)
                        <h1 style="color: #F00;">(CANCELADO)</h1>
                        @endif
                    </td>
                    <td width="20%">
                        <b>Fecha:</b><br>{{ date('Y-m-d', strtotime($vehiculoslista['created_at'])) }}
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <div id="firma">
        @if($vehiculoslista['proyectovehiculo_autorizado'] > 0)
        <div style="border: 1px #555555 solid; width: 220px; margin: 0px auto 4px auto">
            Documento firmado digitalmente por:<br>
            {{ $vehiculoslista['proyectovehiculo_autorizadonombre'] }}<br>
            {{ $vehiculoslista['proyectovehiculo_autorizadofecha'] }}
        </div>
        @else
        <br>
        @endif

	...
	<div class="col-4">
		<div class="card">
			<div class="card-body bg-secondary">
				...
				<h6 class="card-subtitle text-white">Módulo reconocimiento sensorial</h6>
			</div>
						...
						<table class="table table-hover stylish-table" id="tabla_lista_catalogos" width="100%">
							...
							<tbody>
								...
								<tr id="tr_17">
									...
									<td>
										<a href="#" onclick="mostrar_catalogo(17);">
			...
			<form method="post" enctype="multipart/form-data" name="form_conclusion" id="form_conclusion">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-12">
							<input type="hidden" class="form-control" id="catalogo" name="catalogo" value="16">
						</div>
					</div>
				</div>
				<div class="modal-footer">
			...
			<form method="post" enctype="multipart/form-data" name="form_descripcionarea" id="form_descripcionarea">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-12">
							<input type="hidden" class="form-control" id="catalogo" name="catalogo" value="17">
						</div>
					</div>
				</div>
				<div class="modal-footer">

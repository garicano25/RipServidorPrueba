        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" method="post" name="form_parametro" id="form_parametro">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_titulo">Superficies</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="parametrosuperficie_ubicacion" id="parametrosuperficie_ubicacion" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label> Característica *</label>
                                <select class="custom-select form-control" id="parametrosuperficie_caracteristica" name="parametrosuperficie_caracteristica" required>
                                    <option value=""></option>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label> Puntos *</label>
                                <input type="number" class="form-control" name="parametrosuperficie_puntos" id="parametrosuperficie_puntos" required>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label> Evaluaciones recomendadas (Observación)</label>
                                <textarea class="form-control" rows="2" id="parametrosuperficie_observacion" name="parametrosuperficie_observacion"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    function consulta_opciones_caracteristicas(seleccionado_id)
    {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "/parametrosuperficiecaracteristicas/"+seleccionado_id,
            data:{},
            cache: false,
            success:function(dato)
            {
                    ...
                    $("#chekbox_caracteristicas").append('<div class="col-6">'+
                                                            '<div class="form-group">'+
                                                                '<div class="switch" style="float: left;">'+
                                                                    ...
                                                                    '</label>'+
                                                                '</div>'+
                                                                '<label class="demo-switch-title" style="float: left;">'+value.catparametrosuperficiecaracteristica_caracteristica+'</label>'+
                                                            '</div>'+
                                                        '</div>');
                });
    ...
    function funcion_tabla_parametro(recsensorial_id)
    {
        tabla_parametro = $('#tabla_parametro').DataTable({
            "ajax": {
                "url": "/parametrosuperficietabla/"+recsensorial_id,
                "type": "get",
                "cache": false,
                error: function (xhr, error, code)
                {
                    ...
                    // funcion_tabla_parametro(recsensorial_id);
                    tabla_parametro.ajax.url("/parametrosuperficietabla/"+recsensorial_id).load();
                },
                "data": {}
            },
            "columns": [
                ...
                {
                    "data": "parametrosuperficie_ubicacion",
                    "defaultContent": "-"
                },
                {
                    "data": "parametrosuperficie_caracteristica",
                    "defaultContent": "-"
                },
                {
                    "data": "parametrosuperficie_caracteristica",
                ...
                {
                    "data": "parametrosuperficie_puntos",
                    "defaultContent": "-"
                },
                {
                    "className": 'editar',
    ...
    $(document).ready(function()
    {
        $('#tabla_parametro tbody').on('click', 'td.editar', function() 
        {
            ...
            if (parseInt(row.data().accion_activa) > 0)
            {
                ...
                $("#parametrosuperficie_ubicacion").val(row.data().parametrosuperficie_ubicacion);
                $("#parametrosuperficie_caracteristica").val(row.data().parametrosuperficie_caracteristica);
                $("#parametrosuperficie_puntos").val(row.data().parametrosuperficie_puntos);
                $("#parametrosuperficie_observacion").val(row.data().parametrosuperficie_observacion);
                        ...
                        swal({   
                            ...
                            if (isConfirm)
                            {
                                ...
                                $.ajax({
                                    type: "GET",
                                    dataType: "json",
                                    url: "/parametrosuperficieeliminar/"+row.data().id,
                                    data:{},
                                    cache: false,
                                    success:function(dato){
                                        // actualiza tabla
    ...
    var parametro_id = 12; // ID en base datos
    var parametro_nombre = 'superficies';

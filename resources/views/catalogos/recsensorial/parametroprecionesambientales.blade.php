        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" method="post" name="form_parametro" id="form_parametro">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_titulo">Presiones ambientales anormales</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="parametroprecionesambientales_contaminante" id="parametroprecionesambientales_contaminante" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label> Puntos *</label>
                                <input type="number" class="form-control" name="parametroprecionesambientales_puntos" id="parametroprecionesambientales_puntos" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    function funcion_tabla_parametro(recsensorial_id) {
        tabla_parametro = $('#tabla_parametro').DataTable({
            "ajax": {
                "url": "/parametroprecionesambientalestabla/" + recsensorial_id,
                "type": "get",
                "cache": false,
                error: function(xhr, error, code) {
                    // console.log(xhr); console.log(code);
                    // funcion_tabla_parametro(recsensorial_id);
                    tabla_parametro.ajax.url("/parametroprecionesambientalestabla/" + recsensorial_id).load();
                },
                "data": {}
            },
            "columns": [
                ...
                {
                    "data": "parametroprecionesambientales_contaminante"
                },
                {
                    "data": "parametroprecionesambientales_puntos"
                },
                {
                    "className": 'editar',
                    "orderable": false,
    ...
    $(document).ready(function() {
        $('#tabla_parametro tbody').on('click', 'td.editar', function() {
            ...
            if (parseInt(row.data().accion_activa) > 0) {
                ...
                $("#parametroprecionesambientales_contaminante").val(row.data().parametroprecionesambientales_contaminante);
                $("#parametroprecionesambientales_puntos").val(row.data().parametroprecionesambientales_puntos);
    ...
    $("#boton_guardar_parametro").click(function() {
        ...
        if (valida) {
            ...
            $('#form_parametro').ajaxForm({
                dataType: 'json',
                type: 'POST',
                url: '/parametroprecionesambientales',
                data: {},
                resetForm: false,
                success: function(dato) {
                    // Campos Hidden
                        ...
                        swal({
                            ...
                            if (isConfirm) {
                                ...
                                $.ajax({
                                    type: "GET",
                                    dataType: "json",
                                    url: "/parametroprecionesambientaleseliminar/" + row.data().id,
                                    data: {},
                                    cache: false,
                                    success: function(dato) {
                                        // actualiza tabla
    ...
    var parametro_id = 7; // ID en base datos
    var parametro_nombre = 'presiones ambientales anormales';

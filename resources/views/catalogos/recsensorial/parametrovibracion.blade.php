        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" method="post" name="form_parametro" id="form_parametro">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_titulo">Vibración</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label data-toggle="tooltip" title="Vibraciones de cuerpo entero"> Puntos <b>VCE</b> *</label>
                                <input type="number" class="form-control" name="parametrovibracion_puntovce" id="parametrovibracion_puntovce" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label data-toggle="tooltip" title="Vibraciones en extremidades superiores"> Puntos <b>VES</b> *</label>
                                <input type="number" class="form-control" name="parametrovibracion_puntoves" id="parametrovibracion_puntoves" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    function funcion_tabla_parametro(recsensorial_id)
    {
        tabla_parametro = $('#tabla_parametro').DataTable({
            "ajax": {
                "url": "/parametrovibraciontabla/"+recsensorial_id,
                "type": "get",
                "cache": false,
                error: function (xhr, error, code)
                {
                    ...
                    // funcion_tabla_parametro(recsensorial_id);
                    tabla_parametro.ajax.url("/parametrovibraciontabla/"+recsensorial_id).load();
                },
                "data": {}
            },
            "columns": [
                ...
                {
                    "data": "parametrovibracion_puntovce"
                },
                {
                    "data": "parametrovibracion_puntoves"
                },
                {
                    "className": 'editar',
                    "orderable": false,
    ...
    $(document).ready(function()
    {
        $('#tabla_parametro tbody').on('click', 'td.editar', function() 
        {
            ...
            if (parseInt(row.data().accion_activa) > 0)
            {
                ...
                $("#parametrovibracion_puntovce").val(row.data().parametrovibracion_puntovce);
                $("#parametrovibracion_puntoves").val(row.data().parametrovibracion_puntoves);
                        ...
                        swal({   
                            ...
                            if (isConfirm)
                            {
                                ...
                                $.ajax({
                                    type: "GET",
                                    dataType: "json",
                                    url: "/parametrovibracioneliminar/"+row.data().id,
                                    data:{},
                                    cache: false,
                                    success:function(dato){
                                        // actualiza tabla
    ...
    var parametro_id = 2; // ID en base datos
    var parametro_nombre = 'vibración';

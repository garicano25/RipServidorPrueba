        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" method="post" name="form_parametro" id="form_parametro">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_titulo">Agua</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="parametroagua_ubicacion" id="parametroagua_ubicacion" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                <label> Tipo uso *</label>
                                <select class="custom-select form-control" id="parametroagua_tipouso" name="parametroagua_tipouso" required>
                                    <option value=""></option>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control" id="catparametroaguacaracteristica_id" name="catparametroaguacaracteristica_id" onchange="consulta_opciones_caracteristicas(this.value, 0);" required>
                                    {{-- <option value=""></option> --}}
                                </select>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                <label> Puntos *</label>
                                <input type="number" class="form-control" name="parametroagua_puntos" id="parametroagua_puntos" required>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    function funcion_tabla_parametro(recsensorial_id)
    {
        tabla_parametro = $('#tabla_parametro').DataTable({
            ...
            "columns": [
                ...
                {
                    "data": "parametroagua_ubicacion",
                    "defaultContent": '-'
                },
                {
                    "data": "parametroagua_tipouso.",
                    "defaultContent": '-'
                },
                {
    ...
    $(document).ready(function()
    {
        $('#tabla_parametro tbody').on('click', 'td.editar', function() 
        {
            ...
            if (parseInt(row.data().accion_activa) > 0)
            {
                ...
                $("#parametroagua_ubicacion").val(row.data().parametroagua_ubicacion);
                $("#parametroagua_tipouso").val(row.data().parametroagua_tipouso);
                $("#catparametroaguacaracteristica_id").val(row.data().catparametroaguacaracteristica_id);
                $("#parametroagua_puntos").val(row.data().parametroagua_puntos);
    ...
    var parametro_id = 9; // ID en base datos
    var parametro_nombre = 'agua';

        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" method="post" name="form_parametro" id="form_parametro">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_titulo">Radiacion ionizante</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label> Fuente *</label>
                                <input type="text" class="form-control" name="parametroradiacionionizante_fuente" id="parametroradiacionionizante_fuente" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label> Puntos *</label>
                                <input type="number" class="form-control" name="parametroradiacionionizante_puntos" id="parametroradiacionionizante_puntos" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    function funcion_tabla_parametro(recsensorial_id) {
        tabla_parametro = $('#tabla_parametro').DataTable({
            ...
            "columns": [
                ...
                {
                    "data": "parametroradiacionionizante_fuente"
                },
                {
                    "data": "parametroradiacionionizante_puntos"
                },
                {
                    "className": 'editar',
                    "orderable": false,
    ...
    $(document).ready(function() {
        $('#tabla_parametro tbody').on('click', 'td.editar', function() {
            ...
            if (parseInt(row.data().accion_activa) > 0) {
                ...
                $("#parametroradiacionionizante_fuente").val(row.data().parametroradiacionionizante_fuente);
                $("#parametroradiacionionizante_puntos").val(row.data().parametroradiacionionizante_puntos);
    ...
    var parametro_id = 5; // ID en base datos
    var parametro_nombre = 'radiaciones ionizantes';

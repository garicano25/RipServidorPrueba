        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" method="post" name="form_parametro" id="form_parametro">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_titulo">Radiacion no ionizante</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label> Fuente *</label>
                                <input type="text" class="form-control" name="parametroradiacionnoionizante_fuente" id="parametroradiacionnoionizante_fuente" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label> Puntos *</label>
                                <input type="number" class="form-control" name="parametroradiacionnoionizante_puntos" id="parametroradiacionnoionizante_puntos" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    function funcion_tabla_parametro(recsensorial_id) {
        tabla_parametro = $('#tabla_parametro').DataTable({
            "ajax": {
                "url": "/parametroradiacionnoionizantetabla/" + recsensorial_id,
                "type": "get",
                "cache": false,
                error: function(xhr, error, code) {
                    // console.log(xhr); console.log(code);
                    // funcion_tabla_parametro(recsensorial_id);
                    tabla_parametro.ajax.url("/parametroradiacionnoionizantetabla/" + recsensorial_id).load();
                },
                "data": {}
            },
            "columns": [
                ...
                {
                    "data": "parametroradiacionnoionizante_fuente"
                },
                {
                    "data": "parametroradiacionnoionizante_puntos"
                },
                {
                    "className": 'editar',
                    "orderable": false,
    ...
    $(document).ready(function() {
        $('#tabla_parametro tbody').on('click', 'td.editar', function() {
            ...
            if (parseInt(row.data().accion_activa) > 0) {
                ...
                $("#parametroradiacionnoionizante_fuente").val(row.data().parametroradiacionnoionizante_fuente);
                $("#parametroradiacionnoionizante_puntos").val(row.data().parametroradiacionnoionizante_puntos);
    ...
    $("#boton_guardar_parametro").click(function() {
        ...
        if (valida) {
            ...
            $('#form_parametro').ajaxForm({
                dataType: 'json',
                type: 'POST',
                url: '/parametroradiacionnoionizante',
                data: {},
                resetForm: false,
                success: function(dato) {
                    // Campos Hidden
                        ...
                        swal({
                            ...
                            if (isConfirm) {
                                ...
                                $.ajax({
                                    type: "GET",
                                    dataType: "json",
                                    url: "/parametroradiacionnoionizanteeliminar/" + row.data().id,
                                    data: {},
                                    cache: false,
                                    success: function(dato) {
                                        // actualiza tabla
    ...
    var parametro_id = 6; // ID en base datos
    var parametro_nombre = 'radiaciones no ionizantes';

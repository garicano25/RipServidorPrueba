        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" method="post" name="form_parametro" id="form_parametro">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal_titulo">Temperatura</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label data-toggle="tooltip" title="Temperaturas elevadas"> Puntos <b>TE</b> *</label>
                                <input type="number" class="form-control" name="parametrotemperatura_puntote" id="parametrotemperatura_puntote" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label data-toggle="tooltip" title="Temperaturas abatidas"> Puntos <b>TA</b> *</label>
                                <input type="number" class="form-control" name="parametrotemperatura_puntota" id="parametrotemperatura_puntota" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    function funcion_tabla_parametro(recsensorial_id) {
        tabla_parametro = $('#tabla_parametro').DataTable({
            "ajax": {
                "url": "/parametrotemperaturatabla/" + recsensorial_id,
                "type": "get",
                "cache": false,
                error: function(xhr, error, code) {
                    // console.log(xhr); console.log(code);
                    // funcion_tabla_parametro(recsensorial_id);
                    tabla_parametro.ajax.url("/parametrotemperaturatabla/" + recsensorial_id).load();
                },
                "data": {}
            },
            "columns": [
                ...
                {
                    "data": "parametrotemperatura_puntote"
                },
                {
                    "data": "parametrotemperatura_puntota"
                },
                {
                    "className": 'editar',
                    "orderable": false,
    ...
    $(document).ready(function() {
        $('#tabla_parametro tbody').on('click', 'td.editar', function() {
            ...
            if (parseInt(row.data().accion_activa) > 0) {
                ...
                $("#parametrotemperatura_puntote").val(row.data().parametrotemperatura_puntote);
                $("#parametrotemperatura_puntota").val(row.data().parametrotemperatura_puntota);
                        ...
                        swal({
                            ...
                            if (isConfirm) {
                                ...
                                $.ajax({
                                    type: "GET",
                                    dataType: "json",
                                    url: "/parametrotemperaturaeliminar/" + row.data().id,
                                    data: {},
                                    cache: false,
                                    success: function(dato) {
                                        // actualiza tabla
    ...
    var parametro_id = 3; // ID en base datos
    var parametro_nombre = 'temperatura';

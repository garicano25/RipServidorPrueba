            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab_3" role="tab" id="tab_info_contratos">
                        <span class="hidden-sm-up"><i class="ti-archive"></i></span>
                        <span class="hidden-xs-down">Datos del contrato - PO</span></a>
                </li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                ...
                <div class="tab-pane p-20" id="tab_2" role="tabpanel">
                    <div class="card wizard-content" style="border: none; box-shadow: 0 0 0;">
                        ...
                        @if(auth()->user()->hasRoles(['Superusuario','Administrador']))
                        <ol class="breadcrumb m-b-10">
                            <h2 style="color: #ffff; margin: 0;"> <i class="fa fa-handshake-o" aria-hidden="true"></i> Contratos - PO </h2>
                            <button type="button" class="btn btn-secondary waves-effect waves-light boton_modulocliente" style="margin-left:auto" id="boton_nuevo_contrato">
                                Contrato - PO <i class="fa fa-plus p-1"></i>
                            </button>
                        </ol>
                                        ...
                                        <table class="table" style="border: 0px #000 solid; margin: 0px;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="auto" style="text-align: left; border: none; vertical-align: middle;">
                                                        <h4 style="margin: 0px;"><a class="text-success div_descripcion_contrato">Objeto del contrato - PO</a></h4>
                                                        <small style="color: #AAAAAA; font-size: 12px;">Objeto del contrato - PO</small>
                                                    </td>
                                                    <td width="auto" style="text-align: right; border: none; vertical-align: middle;">
                                                        <h4 style="margin: 0px;"><a class="text-success div_numero_contrato">Número de contrato - PO</a></h4>
                                                        <small style="color: #AAAAAA; font-size: 12px;">Número de contrato - PO</small>
                                                    </td>
                                                    <td width="40" style="text-align: center; border: none;">
                            ...
                            <div class="col-12">
                                <ol class="breadcrumb m-b-10" style="background-color:#ffff; color :#0c3f64;  border: #0c3f64 2px solid;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <p><i class="fa fa-clock-o" aria-hidden="true"></i>Duración del contrato - PO: <span id="contrato_duracion" style="color: #009efb;"></span> </p>
                                        </div>
                                    </div>
                                </ol>
                            </div>
                                                ...
                                                <div class="multisteps-form__content">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            @if(auth()->user()->hasRoles(['Superusuario', 'Administrador']))
                                                            <ol class="breadcrumb m-b-10">
                                                                <h2 style="color: #ffff; margin: 0;"><i class="fa fa-files-o" aria-hidden="true"></i> Documentación del contrato - PO </h2>
                                                            ...
                                                            <ol class="breadcrumb m-b-10">
                                                                <h2 style="color: #ffff; margin: 0;"><i class="fa fa-list-alt" aria-hidden="true"></i> Partidas del contrato - PO </h2>
                                                ...
                                                <div class="multisteps-form__content">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <!-- Partidas del contrato -->
                                                            <ol class="breadcrumb m-b-10">
                                                                <h2 style="color: #ffff; margin: 0;"><i class="fa fa-list-alt" aria-hidden="true"></i> Partidas del contrato - PO (Para convenios) </h2>
                                                            ...
                                                            @else
                                                            <ol class="breadcrumb m-b-10">
                                                                Partidas del contrato - PO (Para convenios)
                                                            </ol>
                                                            @endif
                                                            <br>
                                                            <div class="card">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form enctype="multipart/form-data" method="post" name="form_contrato" id="form_contrato">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title">Información del Contrato - PO</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label>Número de contrato - PO * </label>
                                    <input type="text" step="any" class="form-control" name="NUMERO_CONTRATO" id="NUMERO_CONTRATO" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Objeto del contrato - PO *</label>

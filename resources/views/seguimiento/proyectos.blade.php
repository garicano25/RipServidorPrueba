    ...
    <div class="col-12">
        <div class="card">
        		<div class="card-body bg-success">
                    <div class="row">
                        <div class="col-12">
                			<h2 class="text-white card-title">Administración de  Proyectos</h2>
                			<h4 class="card-subtitle text-white">Seguimiento administrativo</h4>
                        </div>
                    </div>
        		...
        		<div class="card-body">
            		<div class="table-responsive">
                        <table class="table table-hover stylish-table" width="100%" id="tabla_AdministracionProyectos">
                            <thead>
                                <tr>
                                    <th style="width: 60px!important;">No</th>
                                    <th style="width: 130px!important;">Folio</th>
                                    <th>Empresa</th>
                                    <th>Instalación / Dirección</th>
                                    <th style="width: 130px!important;">Inicio / Fin</th>
                                    <th style="width: 130px!important;">Rec. sensorial</th>
...
<div id="modal_ordenservicio" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" style="border: 0px #f00 solid; min-width: 1100px!important;">
        <div class="modal-content">

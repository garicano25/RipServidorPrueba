...
<body>
    <div class="container-fluid">
        <div class="row justify-content-center mt-2 mb-1" id="title">
            <div class="d-flex align-items-center">
                <h1 id="typing-text" class="me-3">Bienvenido(a) {{ Auth::user()->name }}</h1>
            ...
            <li class="nav-item dropdown">
                <div class="dropdown-menu dropdown-menu-right scale-up" style="left:-95px!important" id="user-menu">
                    <ul class="dropdown-user" style="border: 0px #F00 solid; width: 340px;">
                        <li>
                        ...
                        <li class="mt-3 mb-2"><a href="{{ route('usuario.index') }}"><i class="ti-user"></i> Mi perfil</a></li>
                        <li role="separator" class="divider"></li>
        ...
        <div class="row justify-content-center mt-0 mb-5">
            <a href="http://results-in-performance.com/" target="_blank">
                <img src="/assets/images/Logo_Color_results_original.png" class="ld ld-breath" alt="homepage" style="width: 500px; animation-duration:3.0s" />
            </a>
        </div>
        <div class="row" style="margin-top: 80px">
            <!-- Recursos administrativos -->
            <div class="section s1 ld ld-breath" style="animation-duration:6.0s">
                <div class="image-container">
                    <img src="/assets/images/imagen.jpg" alt="Gestión de Clientes">
                </div>
            ...
            <div class="section s2 ld ld-breath" style="animation-duration:7.0s">
                <div class="image-container">
                    <img src="/assets/images/imagen.jpg" alt="Gestión de Ingresos">
                </div>
            ...
            <!-- Higiene Industrial -->
            <div class="section s3 ld ld-breath" style="animation-duration:8.0s">
                <div class="image-container">
            ...
            <div class="section s2 ld ld-breath" style="animation-duration:7.0s">
                <div class="image-container">
                    <img src="/assets/images/imagen.jpg" alt="Gestión de Canales">
                </div>
                <h2>FR. Ergonómico</h2>
                <div class="wrapper mt-3">
                    <a class="cta disabled" href="#" id="btnErgo">
                        <span>Ingresar</span>
                        <span>
                            <svg width="50px" height="20px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <!-- Psicosocial -->
            <div class="section s1 ld ld-breath" style="animation-duration:8.0s">
                <div class="image-container">
                    <img src="/assets/images/imagen.jpg" alt="Limpieza">
                </div>
                <h2>FR. Psicosocial</h2>
                <div class="wrapper mt-5">

...
use App\modelos\recsensorial\parametroradiacionionizanteModel;
...
class parametroradiacionionizanteController extends Controller
{
    /**
     ...
     */
    public function parametroradiacionionizantevista($recsensorial_id)
    {
        // Reconocimiento
        ...
        return view('catalogos.recsensorial.parametroradiacionionizante', compact('recsensorial', 'recsensorialareas', 'recsensorial_id'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function parametroradiacionionizantetabla($recsensorial_id)
    {
        try
        {
            // Reconocimiento
            ...
            $tabla = parametroradiacionionizanteModel::with(['recsensorialarea', 'recsensorialcategoria'])
    ...
    public function store(Request $request)
    {
        try
        {
            ...
            {
                // guardar
                $parametro = parametroradiacionionizanteModel::create($request->all());
            ...
            {
                // modificar
                $parametro = parametroradiacionionizanteModel::findOrFail($request['registro_id']);
     ...
     * @return \Illuminate\Http\Response
     */
    public function parametroradiacionionizanteeliminar($registro_id)
    {
        try
        {
            $parametro = parametroradiacionionizanteModel::where('id', $registro_id)->delete();

        ...
        try {
            ...
            if (!empty($info)) {
                ...
                $datos = DB::select('SELECT DISTINCT PONDERACION2.*,
                                    ...
                                    WHERE PONDERACION1.SUMA_PONDERACIONES1 >= 8 AND PONDERACION1.SUMA_PONDERACIONES2 >= 4) AS PONDERACION2', [$ID, $ID, $ID]);

...
use App\modelos\recsensorial\parametroprecionesambientalesModel;
...
class parametroprecionesambientalesController extends Controller
{
    /**
     ...
     */
    public function parametroprecionesambientalesvista($recsensorial_id)
    {
        // Reconocimiento
        ...
        return view('catalogos.recsensorial.parametroprecionesambientales', compact('recsensorial', 'recsensorialareas', 'recsensorial_id'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function parametroprecionesambientalestabla($recsensorial_id)
    {
        try
        {
            // Reconocimiento
            ...
            $tabla = parametroprecionesambientalesModel::with(['recsensorialarea', 'recsensorialcategoria'])
    ...
    public function store(Request $request)
    {
        try
        {
            ...
            {
                // guardar
                $parametro = parametroprecionesambientalesModel::create($request->all());
            ...
            {
                // modificar
                $parametro = parametroprecionesambientalesModel::findOrFail($request['registro_id']);
     ...
     * @return \Illuminate\Http\Response
     */
    public function parametroprecionesambientaleseliminar($registro_id)
    {
        try
        {
            $parametro = parametroprecionesambientalesModel::where('id', $registro_id)->delete();

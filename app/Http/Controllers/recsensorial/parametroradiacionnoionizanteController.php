...
use App\modelos\recsensorial\parametroradiacionnoionizanteModel;
...
class parametroradiacionnoionizanteController extends Controller
{
    /**
     ...
     */
    public function parametroradiacionnoionizantevista($recsensorial_id)
    {
        // Reconocimiento
        ...
        return view('catalogos.recsensorial.parametroradiacionnoionizante', compact('recsensorial', 'recsensorialareas', 'recsensorial_id'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function parametroradiacionnoionizantetabla($recsensorial_id)
    {
        try
        {
            // Reconocimiento
            ...
            $tabla = parametroradiacionnoionizanteModel::with(['recsensorialarea', 'recsensorialcategoria'])
    ...
    public function store(Request $request)
    {
        try
        {
            ...
            {
                // guardar
                $parametro = parametroradiacionnoionizanteModel::create($request->all());
            ...
            {
                // modificar
                $parametro = parametroradiacionnoionizanteModel::findOrFail($request['registro_id']);
     ...
     * @return \Illuminate\Http\Response
     */
    public function parametroradiacionnoionizanteeliminar($registro_id)
    {
        try
        {
            $parametro = parametroradiacionnoionizanteModel::where('id', $registro_id)->delete();

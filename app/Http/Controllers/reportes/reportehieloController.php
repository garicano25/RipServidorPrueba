        ...
        if (($proyecto->recsensorial->recsensorial_tipocliente + 0) == 1 && ($proyecto->recsensorial_id == NULL || $proyecto->catregion_id == NULL || $proyecto->catsubdireccion_id == NULL || $proyecto->catgerencia_id == NULL || $proyecto->catactivo_id == NULL || $proyecto->proyecto_clienteinstalacion == NULL || $proyecto->proyecto_fechaentrega == NULL)) {
            ...
            if (count($revision) == 0) {
                ...
                $revision = reporterevisionesModel::create([
                    'proyecto_id' => $proyecto_id, 'agente_id' => 10, 'agente_nombre' => 'Hielo', 'reporterevisiones_revision' => 0, 'reporterevisiones_concluido' => 0, 'reporterevisiones_concluidonombre' => NULL, 'reporterevisiones_concluidofecha' => NULL, 'reporterevisiones_cancelado' => 0, 'reporterevisiones_canceladonombre' => NULL, 'reporterevisiones_canceladofecha' => NULL, 'reporterevisiones_canceladoobservacion' => NULL
                ]);
            }
            // ================ DESCOMENTAR DESPUES DE SUBIR AL SERVIDOR =========================
        ...
        try {
            ...
            if ($dato['reporteregistro_id'] >= 0 && $reporte->reportehielo_fecha != NULL && $reporte->proyecto_id == $proyecto_id) {
                ...
                $dato['reporte_portada'] = array(
                    'reporte_catregion_activo' => $reporte->reportehielo_catregion_activo, 'catregion_id' => $proyecto->catregion_id, 'reporte_catsubdireccion_activo' => $reporte->reportehielo_catsubdireccion_activo, 'catsubdireccion_id' => $proyecto->catsubdireccion_id, 'reporte_catgerencia_activo' => $reporte->reportehielo_catgerencia_activo, 'catgerencia_id' => $proyecto->catgerencia_id, 'reporte_catactivo_activo' => $reporte->reportehielo_catactivo_activo, 'catactivo_id' => $proyecto->catactivo_id, 'reporte_instalacion' => $proyecto->proyecto_clienteinstalacion, 'reporte_fecha' => $reportefecha, 'reporte_mes' => $reporte->reporte_mes
            ...
            if ($dato['reporteregistro_id'] >= 0 && $reporte->reportehielo_responsable1 != NULL) {
                ...
                $dato['reporte_responsablesinforme'] = array(
                    'responsable1' => $reporte->reportehielo_responsable1, 'responsable1cargo' => $reporte->reportehielo_responsable1cargo, 'responsable1documento' => $reporte->reportehielo_responsable1documento, 'responsable2' => $reporte->reportehielo_responsable2, 'responsable2cargo' => $reporte->reportehielo_responsable2cargo, 'responsable2documento' => $reporte->reportehielo_responsable2documento, 'proyecto_id' => $reporte->proyecto_id, 'registro_id' => $reporte->id
                );
            } else {
                $dato['reporte_responsablesinforme_guardado'] = 0;
                ...
                if (count($reportehistorial) > 0 && $reportehistorial[0]->reportehielo_responsable1 != NULL) {
                    $dato['reporte_responsablesinforme'] = array(
                        'responsable1' => $reportehistorial[0]->reportehielo_responsable1, 'responsable1cargo' => $reportehistorial[0]->reportehielo_responsable1cargo, 'responsable1documento' => $reportehistorial[0]->reportehielo_responsable1documento, 'responsable2' => $reportehistorial[0]->reportehielo_responsable2, 'responsable2cargo' => $reportehistorial[0]->reportehielo_responsable2cargo, 'responsable2documento' => $reportehistorial[0]->reportehielo_responsable2documento, 'proyecto_id' => $reportehistorial[0]->proyecto_id, 'registro_id' => $reportehistorial[0]->id
                    );
                } else {
                    $dato['reporte_responsablesinforme'] = array(
        ...
        try {
            ...
            if (($request->reporteregistro_id + 0) > 0) {
                ...
                $reporte = reportehieloModel::create([
                    'proyecto_id' => $request->proyecto_id, 'agente_id' => $request->agente_id, 'agente_nombre' => $request->agente_nombre, 'catactivo_id' => $request->catactivo_id, 'reportehielo_revision' => 0, 'reportehielo_instalacion' => $request->reporte_instalacion, 'reportehielo_catregion_activo' => 1, 'reportehielo_catsubdireccion_activo' => 1, 'reportehielo_catgerencia_activo' => 1, 'reportehielo_catactivo_activo' => 1, 'reportehielo_concluido' => 0, 'reportehielo_cancelado' => 0
                ]);
            ...
            if (($request->opcion + 0) == 0) {
                ...
                $reporte->update([
                    'reportehielo_catregion_activo' => $catregion_activo, 'reportehielo_catsubdireccion_activo' => $catsubdireccion_activo, 'reportehielo_catgerencia_activo' => $catgerencia_activo, 'reportehielo_catactivo_activo' => $catactivo_activo, 'reportehielo_instalacion' => $request->reporte_instalacion, 'reportehielo_fecha' => $request->reporte_fecha, 'reporte_mes' => $request->reporte_mes
            ...
            if (($request->opcion + 0) == 1) {
                $reporte->update([
                    'reportehielo_introduccion' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_introduccion), 'reportehielo_introduccion2' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_introduccion2)
                ]);
            ...
            if (($request->opcion + 0) == 4) {
                $reporte->update([
                    'reportehielo_objetivoespecifico' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_objetivoespecifico), 'reportehielo_objetivoespecifico2' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_objetivoespecifico2)
                ]);
            ...
            if (($request->opcion + 0) == 5) {
                $reporte->update([
                    'reportehielo_metodologia_4_1' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_metodologia_4_1), 'reportehielo_metodologia_4_12' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_metodologia_4_12)
                ]);
            ...
            if (($request->opcion + 0) == 6) {
                $reporte->update([
                    'reportehielo_metodologia_4_2' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_metodologia_4_2), 'reportehielo_metodologia_4_22' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_metodologia_4_22)
                ]);
            ...
            if (($request->opcion + 0) == 7) {
                $reporte->update([
                    'reportehielo_metodologia_4_3' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_metodologia_4_3), 'reportehielo_metodologia_4_32' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_metodologia_4_32)
                ]);
                ...
                if ($request->catparametrohielocaracteristica_id) {
                    foreach ($request->catparametrohielocaracteristica_id as $key => $value) {
                        $parametro = reportehieloevaluacionparametrosModel::create([
                            'reportehieloevaluacion_id' => $punto->id, 'catparametrohielocaracteristica_id' => $value, 'reportehieloevaluacionparametros_metodo' => str_replace('<', '˂', str_replace('>', '˃', str_replace('&', 'Ց', $request['reportehieloevaluacionparametros_metodo'][$key]))), 'reportehieloevaluacionparametros_obtenida' => str_replace('<', '˂', str_replace('>', '˃', str_replace('&', 'Ց', $request['reportehieloevaluacionparametros_obtenida'][$key]))), 'reportehieloevaluacionparametros_resultado' => $request['reportehieloevaluacionparametros_resultado'][$key]
                        ]);
                    }
                }
                ...
                if ($request->reportehielocategoria_id) {
                    foreach ($request->reportehielocategoria_id as $key => $value) {
                        $categoria = reportehieloevaluacioncategoriasModel::create([
                            'reportehieloevaluacion_id' => $punto->id, 'reportehielocategoria_id' => $value, 'reportehieloevaluacioncategorias_nombre' => $request['reportehieloevaluacioncategorias_nombre_' . $value], 'reportehieloevaluacioncategorias_ficha' => $request['reportehieloevaluacioncategorias_ficha_' . $value]
                        ]);
                    }
                }
            }
            ...
            if (($request->opcion + 0) == 14) {
                $reporte->update([
                    'reportehielo_conclusion' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_conclusion), 'reportehielo_conclusion2' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_conclusion2)
                ]);
            ...
            if (($request->opcion + 0) == 17) {
                $reporte->update([
                    'reportehielo_responsable1' => $request->reporte_responsable1, 'reportehielo_responsable1cargo' => $request->reporte_responsable1cargo, 'reportehielo_responsable2' => $request->reporte_responsable2, 'reportehielo_responsable2cargo' => $request->reporte_responsable2cargo
                ]);
                ...
                if ($request->responsablesinforme_carpetadocumentoshistorial) {
                    ...
                    $reporte->update([
                        'reportehielo_responsable1documento' => $nuevo_destino . 'responsable1_doc.jpg', 'reportehielo_responsable2documento' => $nuevo_destino . 'responsable2_doc.jpg'
                    ]);
                }

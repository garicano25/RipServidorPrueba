        ...
        if (($proyecto->recsensorial->recsensorial_tipocliente + 0) == 1 && ($proyecto->recsensorial_id == NULL || $proyecto->catregion_id == NULL || $proyecto->catsubdireccion_id == NULL || $proyecto->catgerencia_id == NULL || $proyecto->catactivo_id == NULL || $proyecto->proyecto_clienteinstalacion == NULL || $proyecto->proyecto_fechaentrega == NULL)) {
            ...
            if (count($revision) == 0) {
                ...
                $revision = reporterevisionesModel::create([
                    'proyecto_id' => $proyecto_id, 'agente_id' => $agente_id, 'agente_nombre' => $agente_nombre, 'reporterevisiones_revision' => 0, 'reporterevisiones_concluido' => 0, 'reporterevisiones_concluidonombre' => NULL, 'reporterevisiones_concluidofecha' => NULL, 'reporterevisiones_cancelado' => 0, 'reporterevisiones_canceladonombre' => NULL, 'reporterevisiones_canceladofecha' => NULL, 'reporterevisiones_canceladoobservacion' => NULL
                ]);
            }
        ...
        try {
            ...
            if ($dato['reporteregistro_id'] > 0 && $reporte->reporteserviciopersonal_fecha != NULL) {
                ...
                $dato['reporte_portada'] = array(
                    'reporte_catregion_activo' => $reporte->reporteserviciopersonal_catregion_activo, 'catregion_id' => $proyecto->catregion_id, 'reporte_catsubdireccion_activo' => $reporte->reporteserviciopersonal_catsubdireccion_activo, 'catsubdireccion_id' => $proyecto->catsubdireccion_id, 'reporte_catgerencia_activo' => $reporte->reporteserviciopersonal_catgerencia_activo, 'catgerencia_id' => $proyecto->catgerencia_id, 'reporte_catactivo_activo' => $reporte->reporteserviciopersonal_catactivo_activo, 'catactivo_id' => $proyecto->catactivo_id, 'reporte_instalacion' => $proyecto->proyecto_clienteinstalacion, 'reporte_fecha' => $reportefecha, 'reporte_alcanceinforme' => $reporte->reporteserviciopersonal_alcanceinforme, 'reporte_mes' => $reporte->reporte_mes
                ...
                $dato['reporte_portada'] = array(
                    'reporte_catregion_activo' => 1, 'catregion_id' => $proyecto->catregion_id, 'reporte_catsubdireccion_activo' => 1, 'catsubdireccion_id' => $proyecto->catsubdireccion_id, 'reporte_catgerencia_activo' => 1, 'catgerencia_id' => $proyecto->catgerencia_id, 'reporte_catactivo_activo' => 1, 'catactivo_id' => $proyecto->catactivo_id, 'reporte_instalacion' => $proyecto->proyecto_clienteinstalacion, 'reporte_fecha' => $reportefecha, 'reporte_alcanceinforme' => '', 'reporte_mes' => $reporte->reporte_mes
            ...
            if ($dato['reporteregistro_id'] >= 0 && $reporte->reporteserviciopersonal_responsable1 != NULL) {
                ...
                $dato['reporte_responsablesinforme'] = array(
                    'responsable1' => $reporte->reporteserviciopersonal_responsable1, 'responsable1cargo' => $reporte->reporteserviciopersonal_responsable1cargo, 'responsable1documento' => $reporte->reporteserviciopersonal_responsable1documento, 'responsable2' => $reporte->reporteserviciopersonal_responsable2, 'responsable2cargo' => $reporte->reporteserviciopersonal_responsable2cargo, 'responsable2documento' => $reporte->reporteserviciopersonal_responsable2documento, 'proyecto_id' => $reporte->proyecto_id, 'registro_id' => $reporte->id
                );
            } else {
                $dato['reporte_responsablesinforme_guardado'] = 0;
                ...
                if (count($reportehistorial) > 0 && $reportehistorial[0]->reporteserviciopersonal_responsable1 != NULL) {
                    $dato['reporte_responsablesinforme'] = array(
                        'responsable1' => $reportehistorial[0]->reporteserviciopersonal_responsable1, 'responsable1cargo' => $reportehistorial[0]->reporteserviciopersonal_responsable1cargo, 'responsable1documento' => $reportehistorial[0]->reporteserviciopersonal_responsable1documento, 'responsable2' => $reportehistorial[0]->reporteserviciopersonal_responsable2, 'responsable2cargo' => $reportehistorial[0]->reporteserviciopersonal_responsable2cargo, 'responsable2documento' => $reportehistorial[0]->reporteserviciopersonal_responsable2documento, 'proyecto_id' => $reportehistorial[0]->proyecto_id, 'registro_id' => $reportehistorial[0]->id
                    );
                } else {
                    $dato['reporte_responsablesinforme'] = array(
    ...
    public function reporteserviciopersonalevaluacionpyd($proyecto_id)
    {
        try {
            ...
            if (count($evaluacion_pyd) > 0) {
                ...
                $E_resultado = 'Si cumple';
                $E_color = 'background: #00FF00; color: #000000;';
                $L_resultado = 'Si cumple';
                $L_color = 'background: #00FF00; color: #000000;';
                $M_resultado = 'Si cumple';
                $M_color = 'background: #00FF00; color: #000000;';
                $R_resultado = 'Si cumple';
                $R_color = 'background: #00FF00; color: #000000;';
                ...
                if (($evaluacion_pyd[0]->reporteserviciopersonalevaluacionpyd_m2 + 0) > 0) {
                    ...
                    $E_resultado = 'No aplica';
                    $E_color = 'background: none; color: #000000;';
                    $L_resultado = 'No aplica';
                    $L_color = 'background: none; color: #000000;';
                    $M_resultado = 'No aplica';
                    $M_color = 'background: none; color: #000000;';
                    $R_resultado = 'No aplica';
                    $R_color = 'background: none; color: #000000;';
                }
        ...
        try {
            ...
            if (($request->reporteregistro_id + 0) > 0) {
                ...
                $reporte = reporteserviciopersonalModel::create([
                    'proyecto_id' => $request->proyecto_id, 'agente_id' => $request->agente_id, 'agente_nombre' => $request->agente_nombre, 'catactivo_id' => $request->catactivo_id, 'reporteserviciopersonal_instalacion' => $request->reporte_instalacion, 'reporteserviciopersonal_catregion_activo' => 1, 'reporteserviciopersonal_catsubdireccion_activo' => 1, 'reporteserviciopersonal_catgerencia_activo' => 1, 'reporteserviciopersonal_catactivo_activo' => 1, 'reporteserviciopersonal_concluido' => 0, 'reporteserviciopersonal_cancelado' => 0
                ]);
            }
            ...
            if (($request->opcion + 0) == 0) {
                ...
                $reporte->update([
                    'reporteserviciopersonal_catregion_activo' => $catregion_activo, 'reporteserviciopersonal_catsubdireccion_activo' => $catsubdireccion_activo, 'reporteserviciopersonal_catgerencia_activo' => $catgerencia_activo, 'reporteserviciopersonal_catactivo_activo' => $catactivo_activo, 'reporteserviciopersonal_instalacion' => $request->reporte_instalacion, 'reporteserviciopersonal_fecha' => $request->reporte_fecha, 'reporte_mes' => $request->reporte_mes, 'reporteserviciopersonal_alcanceinforme' => $request->reporte_alcanceinforme
                ]);
            ...
            if (($request->opcion + 0) == 14) {
                $reporte->update([
                    'reporteserviciopersonal_responsable1' => $request->reporte_responsable1, 'reporteserviciopersonal_responsable1cargo' => $request->reporte_responsable1cargo, 'reporteserviciopersonal_responsable2' => $request->reporte_responsable2, 'reporteserviciopersonal_responsable2cargo' => $request->reporte_responsable2cargo
                ]);
                ...
                if ($request->responsablesinforme_carpetadocumentoshistorial) {
                    ...
                    $reporte->update([
                        'reporteserviciopersonal_responsable1documento' => $nuevo_destino . 'responsable1_doc.jpg', 'reporteserviciopersonal_responsable2documento' => $nuevo_destino . 'responsable2_doc.jpg'
                    ]);
                }
                ...
                if (($request->condicioninsegura_id + 0) == 0) {
                    ...
                    foreach ($request->checkbox_categoria_id as $key => $value) {
                        reporteserviciopersonalcondicioninseguracategoriasModel::create([
                            'reporteserviciopersonalcondicioninsegura_id' => $condicioninsegura->id, 'reportecategoria_id' => $value
                        ]);
                    }
                    ...
                    foreach ($request->checkbox_categoria_id as $key => $value) {
                        reporteserviciopersonalcondicioninseguracategoriasModel::create([
                            'reporteserviciopersonalcondicioninsegura_id' => $request->condicioninsegura_id, 'reportecategoria_id' => $value
                        ]);
                    }

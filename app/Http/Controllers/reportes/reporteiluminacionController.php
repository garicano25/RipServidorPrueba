...
class reporteiluminacionController extends Controller
{
    ...
    public function reporteiluminacionvista($proyecto_id)
    {
        ...
        else
        {
            ...
            // Vista
            return view('reportes.parametros.reporteiluminacion', compact('proyecto', 'recsensorial', 'catregion', 'catsubdireccion', 'catgerencia', 'catactivo', 'categorias_poe', 'areas_poe'));
        }
    }
    ...
    */
    ...
    public function reporteiluminacionareas($proyecto_id, $reporteiluminacion_id, $areas_poe)
    {
        try
        {
            $numero_registro = 0; $numero_registro2 = 0; $total_singuardar = 0; $instalacion = 'XXX'; $area = 'XXX'; $area2 = 'XXX'; $selectareasoption = ''; $tabla_5_4 = NULL; $tabla_5_5 = NULL; $tabla_6_1 = NULL; $tabla_6_2_1 = NULL; $dato['total_ic'] = 0; $tabla_6_2_2 = NULL; $dato['total_pt'] = 0;
            ...
            if (($areas_poe+0) == 1)
            {
                ...
                foreach ($areacategorias as $key => $value) 
                {
                    ...
                    $areacategorias_lista .= '<tr>
                                                ...
                                                <td width="">
                                                    <textarea rows="2" class="form-control areacategoria_'.$numero_registro.'" name="reporteareacategoria_tareavisual_'.$value->id.'" '.$readonly_required.'>'.$value->categoria_tareavisual.'</textarea>
                                                </td>
                                            </tr>';
                }
            }

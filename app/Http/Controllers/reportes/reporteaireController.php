        ...
        try {
            ...
            if ($dato['reporteregistro_id'] >= 0 && $reporte->reporteaire_fecha != NULL && $reporte->proyecto_id == $proyecto_id) {
                ...
                $dato['reporte_portada'] = array(
                    'reporte_catregion_activo' => $reporte->reporteaire_catregion_activo, 'catregion_id' => $proyecto->catregion_id, 'reporte_catsubdireccion_activo' => $reporte->reporteaire_catsubdireccion_activo, 'catsubdireccion_id' => $proyecto->catsubdireccion_id, 'reporte_catgerencia_activo' => $reporte->reporteaire_catgerencia_activo, 'catgerencia_id' => $proyecto->catgerencia_id, 'reporte_catactivo_activo' => $reporte->reporteaire_catactivo_activo, 'catactivo_id' => $proyecto->catactivo_id, 'reporte_instalacion' => $proyecto->proyecto_clienteinstalacion, 'reporte_fecha' => $reportefecha, 'reporte_mes' => $reporte->reporte_mes
            ...
            if ($dato['reporteregistro_id'] >= 0 && $reporte->reporteaire_responsable1 != NULL) {
                ...
                $dato['reporte_responsablesinforme'] = array(
                    'responsable1' => $reporte->reporteaire_responsable1, 'responsable1cargo' => $reporte->reporteaire_responsable1cargo, 'responsable1documento' => $reporte->reporteaire_responsable1documento, 'responsable2' => $reporte->reporteaire_responsable2, 'responsable2cargo' => $reporte->reporteaire_responsable2cargo, 'responsable2documento' => $reporte->reporteaire_responsable2documento, 'proyecto_id' => $reporte->proyecto_id, 'registro_id' => $reporte->id
                );
            } else {
                $dato['reporte_responsablesinforme_guardado'] = 0;
                ...
                if (count($reportehistorial) > 0 && $reportehistorial[0]->reporteaire_responsable1 != NULL) {
                    $dato['reporte_responsablesinforme'] = array(
                        'responsable1' => $reportehistorial[0]->reporteaire_responsable1, 'responsable1cargo' => $reportehistorial[0]->reporteaire_responsable1cargo, 'responsable1documento' => $reportehistorial[0]->reporteaire_responsable1documento, 'responsable2' => $reportehistorial[0]->reporteaire_responsable2, 'responsable2cargo' => $reportehistorial[0]->reporteaire_responsable2cargo, 'responsable2documento' => $reportehistorial[0]->reporteaire_responsable2documento, 'proyecto_id' => $reportehistorial[0]->proyecto_id, 'registro_id' => $reportehistorial[0]->id
                    );
                } else {
                    $dato['reporte_responsablesinforme'] = array(
        ...
        try {
            ...
            if (($request->reporteregistro_id + 0) > 0) {
                ...
                $reporte = reporteaireModel::create([
                    'proyecto_id' => $request->proyecto_id, 'agente_id' => $request->agente_id, 'agente_nombre' => $request->agente_nombre, 'catactivo_id' => $request->catactivo_id, 'reporteaire_revision' => 0, 'reporteaire_instalacion' => $request->reporte_instalacion, 'reporteaire_catregion_activo' => 1, 'reporteaire_catsubdireccion_activo' => 1, 'reporteaire_catgerencia_activo' => 1, 'reporteaire_catactivo_activo' => 1, 'reporteaire_concluido' => 0, 'reporteaire_cancelado' => 0
                ]);
            ...
            if (($request->opcion + 0) == 0) {
                ...
                $reporte->update([
                    'reporteaire_catregion_activo' => $catregion_activo, 'reporteaire_catsubdireccion_activo' => $catsubdireccion_activo, 'reporteaire_catgerencia_activo' => $catgerencia_activo, 'reporteaire_catactivo_activo' => $catactivo_activo, 'reporteaire_instalacion' => $request->reporte_instalacion, 'reporteaire_fecha' => $request->reporte_fecha, 'reporte_mes' => $request->reporte_mes
            ...
            if (($request->opcion + 0) == 8) {
                $reporte->update([
                    'reporteaire_procesoinstalacion' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_procesoinstalacion), 'reporteaire_actividadprincipal' => $this->datosproyectolimpiartexto($proyecto, $recsensorial, $request->reporte_actividadprincipal)
                ]);
                ...
                if (($request->areas_poe + 0) == 1) {
                    ...
                    if ($request->checkbox_categoria_id) {
                        ...
                        foreach ($request->checkbox_categoria_id as $key => $value) {
                            $areacategoria = reporteaireareacategoriaModel::create([
                                'reporteairearea_id' => $area->id, 'reporteairecategoria_id' => $value, 'reporteaireareacategoria_poe' => $request->reporteregistro_id, 'reporteaireareacategoria_total' => $request['areacategoria_total_' . $value], 'reporteaireareacategoria_actividades' => $request['areacategoria_actividades_' . $value]
                            ]);
                        }
                    }
                    ...
                    if (($request->reportearea_id + 0) == 0) {
                        ...
                        if ($request->checkbox_categoria_id) {
                            ...
                            foreach ($request->checkbox_categoria_id as $key => $value) {
                                $areacategoria = reporteaireareacategoriaModel::create([
                                    'reporteairearea_id' => $area->id, 'reporteairecategoria_id' => $value, 'reporteaireareacategoria_poe' => 0, 'reporteaireareacategoria_total' => $request['areacategoria_total_' . $value], 'reporteaireareacategoria_actividades' => $request['areacategoria_actividades_' . $value]
                                ]);
                            }
                        }
                ...
                if ($request->reporteairecategoria_id) {
                    foreach ($request->reporteairecategoria_id as $key => $value) {
                        $categoria = reporteaireevaluacioncategoriasModel::create([
                            'reporteaireevaluacion_id' => $punto->id, 'reporteairecategoria_id' => $value, 'reporteaireevaluacioncategorias_nombre' => $request['reporteaireevaluacioncategorias_nombre'][$key], 'reporteaireevaluacioncategorias_ficha' => $request['reporteaireevaluacioncategorias_ficha'][$key], 'reporteaireevaluacioncategorias_geo' => $request['reporteaireevaluacioncategorias_geo'][$key]
                        ]);
                    }
                }
            }
            ...
            if (($request->opcion + 0) == 14) {
                $reporte->update([
                    'reporteaire_responsable1' => $request->reporte_responsable1, 'reporteaire_responsable1cargo' => $request->reporte_responsable1cargo, 'reporteaire_responsable2' => $request->reporte_responsable2, 'reporteaire_responsable2cargo' => $request->reporte_responsable2cargo
                ]);
                ...
                if ($request->responsablesinforme_carpetadocumentoshistorial) {
                    ...
                    $reporte->update([
                        'reporteaire_responsable1documento' => $nuevo_destino . 'responsable1_doc.jpg', 'reporteaire_responsable2documento' => $nuevo_destino . 'responsable2_doc.jpg'
                    ]);
                }

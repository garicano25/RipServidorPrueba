    ...
    public function store(Request $request)
    {
        try
        {
            ...
            if (($request->opcion+0) == 0)
            {
                ...
                $reporte->update([
                      'reporteruido_catregion_activo' => $catregion_activo
                    , 'reporteruido_catsubdireccion_activo' => $catsubdireccion_activo
                    , 'reporteruido_catgerencia_activo' => $catgerencia_activo
                    , 'reporteruido_catactivo_activo' => $catactivo_activo
                    , 'reporteruido_instalacion' => $request->reporte_instalacion

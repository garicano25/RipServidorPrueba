...
class reportenom0352Controller extends Controller
{
     ...
     */
    public function reportenom035vista2($proyecto_id)
    {
        ...
        if ($proyecto->proyecto_clienteinstalacion == NULL || $proyecto->proyecto_fechaentrega == NULL) {
            ...
            // Vista
            return view('reportes.psico.reportenom035guia2', compact('proyecto', 'recsensorial', 'catregion', 'catsubdireccion', 'catgerencia', 'catactivo', 'categorias_poe', 'areas_poe', 'catConclusiones'));
        }
    }
}

...
class recsensorialquimicosreportewordController extends Controller
{
    ...
    public function recsensorialquimicosreporte1word($recsensorial_id)
    {
        ...
        $plantillaword->setValue('folio', $recsensorial[0]->recsensorial_folioquimico);
        ...
        // TABLA 5.1 INVENTARIO DE SUSTANCIAS
        //================================================================================
        ...
        $table->addCell(2250, $encabezado_celda)->addTextRun($centrado)->addText('Nombre de la<w:br />sustancia', $encabezado_texto);
        $table->addCell(2250, $encabezado_celda)->addTextRun($centrado)->addText('Cantidad manejada por jornada de trabajo (i, ii, iii)', $encabezado_texto);
        $table->addCell(2250, $encabezado_celda)->addTextRun($centrado)->addText('Estado físico de la<w:br />sustancia química', $encabezado_texto);
        $table->addCell(2250, $encabezado_celda)->addTextRun($centrado)->addText('Vía(s) de ingreso<w:br />al organismo', $encabezado_texto);
        $table->addCell(2250, $encabezado_celda)->addTextRun($centrado)->addText('Grado de riesgo<w:br />a la salud', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            if ($area != $value->recsensorialarea_nombre) {
                ...
                $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->catgradoriesgosalud_id . "/" . $value->catgradoriesgosalud_clasificacion, $texto);
        ...
        // TABLA 6.1 COMPONENTES DE LAS SUSTANCIAS
        //================================================================================
        ...
        $table->addRow(200, array('tblHeader' => true));
        // $table->addCell(2250, $encabezado_celda)->addTextRun($centrado)->addText('Área', $encabezado_texto);
        $table->addCell(3150, $encabezado_celda)->addTextRun($centrado)->addText('Nombre de la<w:br />sustancia', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            ...
            if ($sustancia != $value->catsustancia_nombre) {
                ...
                $table->addCell(3150, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_nombre, $texto);
                $table->addCell(1200, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_cas, $texto);
                $table->addCell(1200, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_ebullicion, $texto);
                $table->addCell(1200, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_porcentaje, $texto);
                $table->addCell(1200, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_pesomolecular, $texto);
                $table->addCell(1200, $celda)->addTextRun($centrado)->addText($value->catestadofisicosustancia_estado, $texto);
                $table->addCell(1200, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_volatilidad, $texto);
        ...
        // encabezado tabla
        $table->addRow(200, array('tblHeader' => true));
        $table->addCell(2700, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Nombre de la sustancia', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            if ($sustancia != $value->catsustancia_nombre) {
                ...
                $table->addCell(2700, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_nombre, $texto);
                $table->addCell(2700, $combinar_fila)->addTextRun($centrado)->addText($value->catviaingresoorganismo_viaingreso, $texto);
                $table->addCell(2700, $combinar_fila)->addTextRun($centrado)->addText($value->catgradoriesgosalud_clasificacion, $texto);
                $table->addCell(1350, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_exposicionppt, $texto);
                $table->addCell(1350, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_exposicionctop, $texto);
                ...
                $table->addCell(2700, $continua_fila);
                $table->addCell(2700, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_nombre, $texto);
                $table->addCell(2700, $continua_fila)->addTextRun($centrado)->addText($value->catviaingresoorganismo_viaingreso, $texto);
                $table->addCell(2700, $continua_fila)->addTextRun($centrado)->addText($value->catgradoriesgosalud_clasificacion, $texto);
                $table->addCell(1350, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_exposicionppt, $texto);
                $table->addCell(1350, $celda)->addTextRun($centrado)->addText($value->catsustanciacomponente_exposicionctop, $texto);
            }
        }
        ...
        // TABLA 7.1 Tabla Fuentes generadoras
        //================================================================================
        ...
        // TABLA 7.2 Tabla Condiciones y características del área de proceso
        //================================================================================
        ...
        $table->addCell(4000, $encabezado_celda)->addTextRun($centrado)->addText('Generación del contaminante', $encabezado_texto);
        ...
        $table->addCell(3500, array('vMerge' => 'restart', 'bgColor' => '1A5276', 'valign' => 'center'))->addTextRun($centrado)->addText('Sustancia química', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            if ($area != $value->area_nombre) {
                $table->addRow(); //fila
                $table->addCell(null, $combinar_fila)->addTextRun($centrado)->addText($value->area_nombre, $texto);
                $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->sustancia_nombre, $texto);
                $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->ponderacion_cantidad, $texto);
                $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->ponderacion_riesgo, $texto);
        ...
        $table->addCell(3500, array('vMerge' => 'restart', 'bgColor' => '1A5276', 'valign' => 'center'))->addTextRun($centrado)->addText('Sustancias químicas presentes en el área, proceso o puesto de trabajo<w:br />(Tabla 9)', $encabezado_texto);
        $table->addCell(4500, array('gridSpan' => 3, 'bgColor' => '1A5276', 'valign' => 'center'))->addTextRun($centrado)->addText('Valor de ponderación', $encabezado_texto); // combina columna
        $table->addCell(1500, array('vMerge' => 'restart', 'bgColor' => '1A5276', 'valign' => 'center'))->addTextRun($centrado)->addText('TOTAL<w:br />(Suma de los valores de ponderación)', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            if ($area != $value->area_nombre) {
                ...
                $table->addRow(); //fila
                $table->addCell(2300, $combinar_fila)->addTextRun($centrado)->addText($value->area_nombre, $texto);

                if ($categoria != $value->categoria_nombre) {
                    $table->addCell(2300, $combinar_fila)->addTextRun($centrado)->addText($value->categoria_nombre, $textonegrita);

                    if ($sustancia != $value->sustancia_nombre) {
                        $table->addCell(2300, $combinar_fila)->addTextRun($centrado)->addText($value->sustancia_nombre, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->tot_ingresoorganismo, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->tot_personalexposicion, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->tot_tiempoexposicion, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->TOTAL2, $texto);
                        $table->addCell(null, array('bgColor' => $value->COLOR, 'valign' => 'center'))->addTextRun($centrado)->addText($value->PRIORIDAD2, $texto);
        ...
        $table->addCell(1700, $encabezado_celda)->addTextRun($centrado)->addText('Agentes químicos evaluados', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            if ($area != $value->area_nombre) {
                ...
                if ($categoria != $value->categoria_nombre) {
                    ...
                    if ($sustancia != $value->sustancia_nombre) {
                        $table->addCell(2300, $combinar_fila)->addTextRun($centrado)->addText($value->sustancia_nombre, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->tot_trabajadores, $texto);
                        ...
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->suma_tiempoexposicion, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->horas_jornada, $texto);
                        $table->addCell(null, array('bgColor' => $value->COLOR, 'valign' => 'center'))->addTextRun($centrado)->addText($value->PRIORIDAD2, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->NUMERO_MUESTREOS, $texto);
                    ...
                    if ($sustancia != $value->sustancia_nombre) {
                        ...
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->frecuencia_expo, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->suma_tiempoexposicion, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText('Checar Hoario', $texto);
                        $table->addCell(null, array('bgColor' => $value->COLOR, 'valign' => 'center'))->addTextRun($centrado)->addText($value->PRIORIDAD2, $texto);
                        $table->addCell(null, $celda)->addTextRun($centrado)->addText($value->NUMERO_MUESTREOS, $texto);
        ...
        // TABLA 11.2 Actividades del personal expuesto
        //================================================================================
        ...
        // TABLA 11.3 Equipo de protección personal suministrado
        //================================================================================
        ...
        // TABLA 12.1 - RESUMEN VERSION 1 [PUNTOS DE MUESTREOS (NORMA)]
        //================================================================================
        ...
        $table->addCell(4350, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Agente químico considerado para evaluar', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            if ($categoria != $value->categoria_nombre_solo) {
                $table->addRow(); //fila
                $table->addCell(4350, $combinar_fila)->addTextRun($centrado)->addText($value->categoria_nombre_solo, $textonegrita);
                $table->addCell(4350, $celda)->addTextRun($centrado)->addText($value->componente, $texto);
        ...
        // TABLA 12.2 - RESUMEN VERSION 2 [PUNTOS DE MUESTREOS (CLIENTE)]
        //================================================================================
        ...
        $sql = DB::select('SELECT
                                ...
                                TABLA5.componente,
                                IF(SUM(TABLA5.MUESTREO_PPT) > 0, SUM(TABLA5.TOTAL_MUESTREOS), "ND") AS MUESTREO_PPT,
                                IF(SUM(TABLA5.MUESTREO_CT) > 0, SUM(TABLA5.TOTAL_MUESTREOS), "ND") AS MUESTREO_CT,
                                SUM(TABLA5.TOTAL_MUESTREOS) AS TOTAL_MUESTREOS
                            FROM
                                (
                                    SELECT
        ...
        // encabezado tabla
        $table->addRow(200, array('tblHeader' => true));
        $table->addCell(2300, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Áreas evaluadas', $encabezado_texto);
        $table->addCell(2300, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Grupo de exposición homogénea', $encabezado_texto);
        $table->addCell(2300, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Sustancia química', $encabezado_texto);
        $table->addCell(2300, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Agente químico considerado para evaluar', $encabezado_texto);
        $table->addCell(3300, array('gridSpan' => 2, 'valign' => 'center', 'bgColor' => '1A5276'))->addTextRun($centrado)->addText('Número de puntos por POE / punto a considerar', $encabezado_texto); // combina columna
        $table->addCell(1000, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Total puntos', $encabezado_texto);
        $table->addRow(); //fila
        $table->addCell(2300, $continua_fila);
        $table->addCell(2300, $continua_fila);
        $table->addCell(2300, $continua_fila);
        ...
        $table->addCell(1650, $encabezado_celda)->addTextRun($centrado)->addText('PPT', $encabezado_texto);
        $table->addCell(1650, $encabezado_celda)->addTextRun($centrado)->addText('CT', $encabezado_texto);
        $table->addCell(1000, $continua_fila);
        ...
        foreach ($sql as $key => $value) {
            if ($area != $value->area_nombre) {
                // Si cambia de area, reinicia la categoria
                $categoria = 'xxx';
                ...
                if ($categoria != $value->categoria_nombre) {
                    // Si cambia de area, reinicia la sustancia
                    $sustancia = 'xxx';
                    ...
                    if ($sustancia != $value->sustancia_nombre) {
                        ...
                        $table->addCell(1650, $celda)->addTextRun($centrado)->addText($value->MUESTREO_PPT, $texto);
                        $table->addCell(1650, $celda)->addTextRun($centrado)->addText($value->MUESTREO_CT, $texto);
                        $table->addCell(1000, $celda)->addTextRun($centrado)->addText($value->TOTAL_MUESTREOS, $textonegrita);
        ...
        $plantillaword->setComplexBlock('tabla_quimicos_resumen4-2', $table);
        ...
        // TABLA 14.1 - RESUMEN VERSION 1 [PUNTOS DE MUESTREOS Y TIPO DE INSTALACION (NORMA)]
        //================================================================================
        ...
        // encabezado tabla
        $table->addRow(200, array('tblHeader' => true));
        $table->addCell(3450, $combinar_fila_encabezado)->addTextRun($centrado)->addText('Agente químico', $encabezado_texto);
        ...
        foreach ($sql as $key => $value) {
            $table->addRow(); //fila
            $table->addCell(3450, $celda)->addTextRun($centrado)->addText($value->componente, $texto);
            $table->addCell(1400, $celda)->addTextRun($centrado)->addText($value->MUESTREO_PPT, $texto);
            $table->addCell(1400, $celda)->addTextRun($centrado)->addText($value->MUESTREO_CT, $texto);
            $table->addCell(1200, $celda)->addTextRun($centrado)->addText($value->TOTAL_MUESTREOS, $textonegrita);
        ...
        // TABLA 14.2 - RESUMEN VERSION 2 [PUNTOS DE MUESTREOS Y TIPO DE INSTALACION (CLIENTE)]
        //================================================================================
        ...
        $sql = DB::select('SELECT
                                TABLA6.componente,
                                IF(TABLA6.MUESTREO_PPT > 0, SUM(TABLA6.TOTAL_MUESTREOS), "ND") AS MUESTREO_PPT,
                                IF(TABLA6.MUESTREO_CT > 0, SUM(TABLA6.TOTAL_MUESTREOS), "ND") AS MUESTREO_CT,
                                SUM(TABLA6.TOTAL_MUESTREOS) AS TOTAL_MUESTREOS,
                                (
                                    CASE
                                        WHEN SUM(TABLA6.TOTAL_MUESTREOS) >= 151 THEN "Extra grande"
                            ...
                            FROM
                                (
                                    SELECT
                                        ...
                                        IF(TABLA5.MUESTREO_PPT > 0, TABLA5.TOTAL_MUESTREOS, "ND") AS MUESTREO_PPT,
                                        IF(TABLA5.MUESTREO_CT > 0, TABLA5.TOTAL_MUESTREOS, "ND") AS MUESTREO_CT,
                                        TABLA5.TOTAL_MUESTREOS AS TOTAL_MUESTREOS
                                    FROM
                                        (
                                            SELECT
                                                -- *,
        ...
        $plantillaword->setComplexBlock('tabla_resumen_quimicos2', $table);
